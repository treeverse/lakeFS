...
const GettingStartedCreateRepoButton = ({
  ...
  return (
    <Button
      className="create-sample-repo-button"
      style={style}
      variant={variant}
            ...
            <Card>
              <Card.Body>
                ...
                <p>
                  <small>
                    created at{" "}
                    <code>{dayjs.unix(repo.creation_date).toISOString()}</code>{" "}
                    ({dayjs.unix(repo.creation_date).fromNow()})<br />
                    default branch: <code>{repo.default_branch}</code>, storage
                    namespace: <code>{repo.storage_namespace}</code>
                  </small>
                </p>
              </Card.Body>
            </Card>
...
export const RepositoriesPage = () => {
  ...
  const [prefix, setPrefix] = useDebouncedState(routerPfx, (prefix) =>
    router.push({ pathname: `/repositories`, query: { prefix } })
  );

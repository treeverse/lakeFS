...
const CompareList = ({
  ...
  const changesTreeMessage = (
    <p>
      Showing changes between <strong>{reference.id}</strong> and{" "}
      <strong>{compareReference.id}</strong>
    </p>
  );
    ...
    <>
      <ActionsBar>
        <ActionGroup orientation="left">
          ...
          <OverlayTrigger
            placement="bottom"
            overlay={<Tooltip>Switch directions</Tooltip>}
          >
            <span>
        ...
        <ActionGroup orientation="right">
          ...
          {compareReference.type === RefTypeBranch &&
...
const MergeButton = ({
  ...
  const [showDeltaMergeComingSoonModal, setShowDeltaMergeComingSoonModal] =
    useState(false);
    ...
    <>
      <Modal show={mergeState.show} onHide={hide} size="lg">
        ...
        <Modal.Body>
          ...
          <FormHelperText>
            In case of a merge conflict, this option will force the merge
            process to automatically favor changes from <b>{dest}</b>{" "}
            (&rdquo;dest-wins&rdquo;) or from <b>{source}</b>{" "}
            (&rdquo;source-wins&rdquo;). In case no selection is made, the merge
      ...
      <ComingSoonModal
        display={showDeltaMergeComingSoonModal}
      ...
      <Button
        variant="success"
        disabled={disabled}
        onClick={() => onClickMerge(isTableMerge)}
      >

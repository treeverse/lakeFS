...
const CreateTagButton = ({
  ...
  return (
    <>
      ...
      <Button variant={variant} onClick={display}>
        {children}
      </Button>
    </>
  );
...
const TagList = ({ repo, after, prefix, onPaginate }) => {
  ...
  const { results, error, loading, nextPage } =
    useAPIWithPagination(async () => {
    ...
    <>
      <div className="mb-5">
        ...
        <div className={"mt-2"}>
          ...
          <a
            href="https://docs.lakefs.io/understand/object-model.html#identifying-commits"
            target="_blank"

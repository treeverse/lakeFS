  ...
  return (
    <div className="mt-3 mb-5">
      ...
      <div>
        ...
        This policy determines for how long objects are kept in the storage
        after they are deleted in lakeFS.{" "}
        <a
          href="https://docs.lakefs.io/reference/garbage-collection.html"
          target="_blank"
          rel="noreferrer"
        >
          Learn more.

...
const DeleteRepositoryModal = ({ repo, show, onSubmit, onCancel }) => {
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        Are you sure you wish to delete repository <strong>{repo.id}</strong>?{" "}
        <br />
        This action cannot be undone. This will delete the following: <br />{" "}
        <br />
        <ul>
          <li>All commits</li>
          <li>All branches</li>
        ...
        Data in the underlying object store will not be deleted by this action.{" "}
        <br /> <br />
        ...
        <Form.Control
          ...
          autoFocus
          ref={repoNameField}
          onChange={compareRepoName}
        />
      </Modal.Body>
      <Modal.Footer>
        <Button disabled={isDisabled} variant="danger" onClick={onSubmit}>
  ...
  return (
    <div className="mt-3 mb-5">
      ...
      <Button
        variant="danger"
        className="mt-3"
        onClick={() => setShowDeleteModal(!showingDeleteModal)}
      >

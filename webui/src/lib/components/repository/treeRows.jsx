...
export const ObjectTreeEntryRow = ({
    entry,
    relativeTo = "",
    diffExpanded,
    depth = 0,
    ...
    if (onRevert) {
        rowActions.push(
            new RowAction(<HistoryIcon />, "Revert changes", null, () => {
    ...
    return (
        <TableRow
            ...
            setShowRevertConfirm={() => setShowRevertConfirm(false)}
        />
    );
};

export const PrefixTreeEntryRow = ({
    entry,
    relativeTo = "",
    dirExpanded,
    depth = 0,
...
const PrefixExpansionSection = ({ dirExpanded, onClick }) => {
    return (
        <span onClick={onClick} className="prefix-expand-icon">

...
var (
	ErrInvalidBranchName    = fmt.Errorf("branch name: %w", ErrInvalid)
	ErrInvalidRef           = fmt.Errorf("ref: %w", ErrInvalid)
	ErrInvalidRepositoryId  = fmt.Errorf("repository name: %w", ErrInvalid)
	ErrInvalidPath          = fmt.Errorf("path: %w", ErrInvalid)
	ErrInvalidCommitId      = fmt.Errorf("commit ID: %w", ErrInvalid)
	ErrInvalidCommitMessage = fmt.Errorf("commit message: %w", ErrInvalid)
)

...
func (g *FakeGraveler) Revert(ctx context.Context, repositoryID graveler.RepositoryID, branchID graveler.BranchID, ref graveler.Ref, _, _ string, _ graveler.Metadata) (graveler.CommitID, error) {
	panic("implement me")
}

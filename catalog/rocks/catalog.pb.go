...
type Entry struct {
	...
	ETag         []byte                 `protobuf:"bytes,4,opt,name=e_tag,json=eTag,proto3" json:"e_tag,omitempty"`
...
var file_catalog_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x04, 0x65, 0x54, 0x61, 0x67, 0x12, 0x38, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64,

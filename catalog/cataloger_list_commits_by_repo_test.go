...
func TestCataloger_ListCommitsByRepo(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []*CommitLog{
				{Branch: "b1", CommitID: 1, Committer: "tester", Message: "commit1", Metadata: Metadata{}},
				{Branch: "b1", CommitID: 2, Committer: "tester", Message: "commit2", Metadata: Metadata{}},
				{Branch: "b1", CommitID: 3, Committer: "tester", Message: "commit3", Metadata: Metadata{}},
				{Branch: "b2", CommitID: 1, Committer: "tester", Message: "commit1", Metadata: Metadata{}},
				{Branch: "b2", CommitID: 2, Committer: "tester", Message: "commit2", Metadata: Metadata{}},
				{Branch: "b2", CommitID: 3, Committer: "tester", Message: "commit3", Metadata: Metadata{}},
			},
			wantMore: false,
			wantErr:  false,
		},

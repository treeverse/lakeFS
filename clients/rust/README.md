...
*CommitsApi* | [**commit_async_status**](docs/CommitsApi.md#commit_async_status) | **GET** /repositories/{repository}/branches/{branch}/commits/status | get status of async commit operation
...
*RefsApi* | [**merge_into_branch_async_status**](docs/RefsApi.md#merge_into_branch_async_status) | **GET** /repositories/{repository}/refs/{sourceRef}/merge/{destinationBranch}/status | get status of async merge operation

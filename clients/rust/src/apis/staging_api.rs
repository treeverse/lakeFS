...
pub async fn link_physical_address(configuration: &configuration::Configuration, repository: &str, branch: &str, path: &str, staging_metadata: models::StagingMetadata, if_none_match: Option<&str>, if_match: Option<&str>) -> Result<models::ObjectStats, Error<LinkPhysicalAddressError>> {
    let local_var_configuration = configuration;

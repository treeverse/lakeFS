...
pub async fn diff_refs(configuration: &configuration::Configuration, repository: &str, left_ref: &str, right_ref: &str, after: Option<&str>, amount: Option<i32>, prefix: Option<&str>, delimiter: Option<&str>, r#type: Option<&str>, include_right_info: Option<bool>) -> Result<models::DiffList, Error<DiffRefsError>> {
    ...
    if let Some(ref local_var_str) = include_right_info {
        local_var_req_builder = local_var_req_builder.query(&[("include_right_info", &local_var_str.to_string())]);
    }

...
**checksums** | Option<**std::collections::HashMap<String, String>**> | Validated full-object checksums of the object content, keyed by checksum algorithm (e.g. CRC64NVME), base64-encoded (S3 convention). Present only when the object was uploaded with checksum validation.  | [optional]

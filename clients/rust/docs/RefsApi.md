...
> models::DiffList diff_refs(repository, left_ref, right_ref, after, amount, prefix, delimiter, r#type, include_right_info)
diff references
...
**include_right_info** | Option<**bool**> | If set to true, the diff will include right-side object info. *EXPERIMENTAL* |  |[default to false]

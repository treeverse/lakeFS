...
public class Constants {
    ...
    public static final String OC_DELETE_JOB_BRANCH = "committer.delete.job_branch";
    public static final String OC_DELETE_TASK_BRANCH = "committer.delete.task_branch";

...
from pylotl.io import ReadableObject, WriteableObject
...
class TestReadableObject:
    ...
    def test_read(self, monkeypatch, tmp_path):
        ...
        with readable_object_context(monkeypatch, tmp_path, **test_kwargs.__dict__) as obj:
            ...
            obj.read()
            assert obj.pos == start_pos + object_stats.size_bytes - 1
            ...
            obj.read(read_size)
            assert obj.pos == start_pos + read_size - 1
            ...
            end_pos = object_stats.size_bytes - 1
            obj.read(read_size)
            assert obj.pos == object_stats.size_bytes - 1
    ...
    def test_exists(self, monkeypatch):
        ...
        with client_context(monkeypatch):
            ...
            try:
                ...
                return
            assert 0, "expected exception to be raised"

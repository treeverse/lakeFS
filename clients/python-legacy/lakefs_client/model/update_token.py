...
class UpdateToken(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, staging_token, *args, **kwargs):  # noqa: E501
        """UpdateToken - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, staging_token, *args, **kwargs):  # noqa: E501
        """UpdateToken - a model defined in OpenAPI

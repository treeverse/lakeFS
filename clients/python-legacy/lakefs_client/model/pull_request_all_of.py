...
class PullRequestAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, creation_date, author, source_branch, destination_branch, *args, **kwargs):  # noqa: E501
        """PullRequestAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, creation_date, author, source_branch, destination_branch, *args, **kwargs):  # noqa: E501
        """PullRequestAllOf - a model defined in OpenAPI

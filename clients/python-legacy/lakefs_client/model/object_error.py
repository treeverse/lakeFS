...
class ObjectError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status_code, message, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, status_code, message, *args, **kwargs):  # noqa: E501
        """ObjectError - a model defined in OpenAPI

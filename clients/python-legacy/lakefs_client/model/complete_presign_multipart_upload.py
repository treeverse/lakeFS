...
def lazy_import():
    ...
    globals()['UploadPart'] = UploadPart


class CompletePresignMultipartUpload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, physical_address, parts, *args, **kwargs):  # noqa: E501
        """CompletePresignMultipartUpload - a model defined in OpenAPI

        Args:
            physical_address (str):
            parts ([UploadPart]): List of uploaded parts, should be ordered by ascending part number
    ...
    @convert_js_args_to_python_args
    def __init__(self, physical_address, parts, *args, **kwargs):  # noqa: E501
        """CompletePresignMultipartUpload - a model defined in OpenAPI

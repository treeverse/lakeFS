...
class ImportLocation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, path, destination, *args, **kwargs):  # noqa: E501
        """ImportLocation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, path, destination, *args, **kwargs):  # noqa: E501
        """ImportLocation - a model defined in OpenAPI

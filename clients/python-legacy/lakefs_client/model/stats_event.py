...
class StatsEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, _class, name, count, *args, **kwargs):  # noqa: E501
        """StatsEvent - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, _class, name, count, *args, **kwargs):  # noqa: E501
        """StatsEvent - a model defined in OpenAPI

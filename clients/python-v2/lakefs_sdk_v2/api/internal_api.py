...
class InternalApi:
    ...
    def prepare_garbage_collection_commits_async(
        ...
        _param = self._prepare_garbage_collection_commits_async_serialize(
            repository=repository,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def prepare_garbage_collection_commits_async_with_http_info(
        self,
        repository: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def prepare_garbage_collection_commits_async_without_preload_content(
        self,
        repository: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _prepare_garbage_collection_commits_async_serialize(
        self,
        repository,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/repositories/{repository}/gc/prepare_commits/async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def prepare_garbage_collection_commits_status(
        self,
        repository: StrictStr,
        id: Annotated[StrictStr, Field(description="Unique identifier of the prepare GC commits task")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._prepare_garbage_collection_commits_status_serialize(
            repository=repository,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def prepare_garbage_collection_commits_status_with_http_info(
        self,
        repository: StrictStr,
        id: Annotated[StrictStr, Field(description="Unique identifier of the prepare GC commits task")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrepareGarbageCollectionCommitsStatus]:
        """get status of prepare gc commits operation
    ...
    @validate_call
    def prepare_garbage_collection_commits_status_without_preload_content(
        self,
        repository: StrictStr,
        id: Annotated[StrictStr, Field(description="Unique identifier of the prepare GC commits task")],
        _request_timeout: Union[
    ...
    def _prepare_garbage_collection_commits_status_serialize(
        self,
        repository,
        id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/repositories/{repository}/gc/prepare_commits/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

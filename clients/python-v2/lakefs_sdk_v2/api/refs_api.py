...
class RefsApi:
    ...
    def diff_refs(
        ...
        include_right_stats: Annotated[Optional[StrictBool], Field(description="If set to true, the diff will include right-side object stats. *EXPERIMENTAL*")] = None,
        ...
        _param = self._diff_refs_serialize(
            ...
            delimiter=delimiter,
            type=type,
            include_right_stats=include_right_stats,
    ...
    def _diff_refs_serialize(
        ...
        if include_right_stats is not None:
            
            _query_params.append(('include_right_stats', include_right_stats))

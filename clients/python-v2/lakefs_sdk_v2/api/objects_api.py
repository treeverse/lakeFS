...
class ObjectsApi:
    ...
    def delete_object(
        ...
        no_tombstone: Annotated[Optional[StrictBool], Field(description="delete entry without tombstone when possible *EXPERIMENTAL*")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_object_serialize(
        ...
        if no_tombstone is not None:
            
            _query_params.append(('no_tombstone', no_tombstone))

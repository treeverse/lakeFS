...
class PrepareGarbageCollectionCommitsStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["task_id", "completed", "update_time", "result", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": GarbageCollectionPrepareResponse.from_dict(obj["result"]) if obj.get("result") is not None else None,

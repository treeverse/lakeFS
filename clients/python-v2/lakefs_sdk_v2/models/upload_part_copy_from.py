...
class UploadPartCopyFrom(BaseModel):
    ...
    copy_source: CopyPartSource
    __properties: ClassVar[List[str]] = ["physical_address", "copy_source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "copy_source": CopyPartSource.from_dict(obj["copy_source"]) if obj.get("copy_source") is not None else None
        })
        return _obj

...
*AuthApi* | [**external_principal_login_1**](docs/AuthApi.md#external_principal_login_1) | **POST** /auth/external/principal/login | perform a login using an external authenticator
...
*ExperimentalApi* | [**create_pull_request_0**](docs/ExperimentalApi.md#create_pull_request_0) | **POST** /repositories/{repository}/pulls | create pull request
*ExperimentalApi* | [**create_user_external_principal_1**](docs/ExperimentalApi.md#create_user_external_principal_1) | **POST** /auth/users/{userId}/external/principals | attach external principal to user
*ExperimentalApi* | [**delete_user_external_principal_1**](docs/ExperimentalApi.md#delete_user_external_principal_1) | **DELETE** /auth/users/{userId}/external/principals | delete external principal from user
*ExperimentalApi* | [**external_principal_login_0**](docs/ExperimentalApi.md#external_principal_login_0) | **POST** /auth/external/principal/login | perform a login using an external authenticator
*ExperimentalApi* | [**get_external_principal_1**](docs/ExperimentalApi.md#get_external_principal_1) | **GET** /auth/external/principals | describe external principal by id
*ExperimentalApi* | [**get_license_0**](docs/ExperimentalApi.md#get_license_0) | **GET** /license | 
*ExperimentalApi* | [**get_pull_request_0**](docs/ExperimentalApi.md#get_pull_request_0) | **GET** /repositories/{repository}/pulls/{pull_request} | get pull request
*ExperimentalApi* | [**get_token_from_mailbox_0**](docs/ExperimentalApi.md#get_token_from_mailbox_0) | **GET** /auth/get-token/mailboxes/{mailbox} | receive the token after user has authenticated on redirect URL.
*ExperimentalApi* | [**get_token_redirect_0**](docs/ExperimentalApi.md#get_token_redirect_0) | **GET** /auth/get-token/start | start acquiring a token by logging in on a browser
...
*ExperimentalApi* | [**list_pull_requests_0**](docs/ExperimentalApi.md#list_pull_requests_0) | **GET** /repositories/{repository}/pulls | list pull requests
*ExperimentalApi* | [**list_user_external_principals_1**](docs/ExperimentalApi.md#list_user_external_principals_1) | **GET** /auth/users/{userId}/external/principals/ls | list user external policies attached to a user
...
*ExperimentalApi* | [**merge_pull_request_0**](docs/ExperimentalApi.md#merge_pull_request_0) | **PUT** /repositories/{repository}/pulls/{pull_request}/merge | merge pull request
*ExperimentalApi* | [**release_token_to_mailbox_0**](docs/ExperimentalApi.md#release_token_to_mailbox_0) | **GET** /auth/get-token/release-token/{loginRequestToken} | release a token for the current (authenticated) user to the mailbox of this login request.
*ExperimentalApi* | [**sts_login**](docs/ExperimentalApi.md#sts_login) | **POST** /sts/login | perform a login with STS
*ExperimentalApi* | [**update_object_user_metadata_0**](docs/ExperimentalApi.md#update_object_user_metadata_0) | **PUT** /repositories/{repository}/branches/{branch}/objects/stat/user_metadata | rewrite (all) object metadata
*ExperimentalApi* | [**update_pull_request_0**](docs/ExperimentalApi.md#update_pull_request_0) | **PATCH** /repositories/{repository}/pulls/{pull_request} | update pull request
...
*ExternalApi* | [**create_user_external_principal_0**](docs/ExternalApi.md#create_user_external_principal_0) | **POST** /auth/users/{userId}/external/principals | attach external principal to user
*ExternalApi* | [**delete_user_external_principal_0**](docs/ExternalApi.md#delete_user_external_principal_0) | **DELETE** /auth/users/{userId}/external/principals | delete external principal from user
...
*ExternalApi* | [**get_external_principal_0**](docs/ExternalApi.md#get_external_principal_0) | **GET** /auth/external/principals | describe external principal by id
*ExternalApi* | [**list_user_external_principals_0**](docs/ExternalApi.md#list_user_external_principals_0) | **GET** /auth/users/{userId}/external/principals/ls | list user external policies attached to a user

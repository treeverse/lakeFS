...
[**external_principal_login_1**](AuthApi.md#external_principal_login_1) | **POST** /auth/external/principal/login | perform a login using an external authenticator
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.AuthApi(api_client)
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_v2.AuthApi(api_client)
    group_creation = lakefs_sdk_v2.GroupCreation() # GroupCreation |  (optional)
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_v2.AuthApi(api_client)
    policy = lakefs_sdk_v2.Policy() # Policy | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_v2.AuthApi(api_client)
    user_creation = lakefs_sdk_v2.UserCreation() # UserCreation |  (optional)
...
# **external_principal_login_1**
> AuthenticationToken external_principal_login_1(external_login_information=external_login_information)
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # perform a login using an external authenticator
        api_response = api_instance.external_principal_login_1(external_login_information=external_login_information)
        print("The response of AuthApi->external_principal_login_1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuthApi->external_principal_login_1: %s\n" % e)
```
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_v2.AuthApi(api_client)
    login_information = lakefs_sdk_v2.LoginInformation() # LoginInformation |  (optional)

...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.RemotesApi(api_client)
    catalog = 'catalog_example' # str | 
    iceberg_pull_request = lakefs_sdk_v2.IcebergPullRequest() # IcebergPullRequest |  (optional)
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.RemotesApi(api_client)
    catalog = 'catalog_example' # str | 
    iceberg_push_request = lakefs_sdk_v2.IcebergPushRequest() # IcebergPushRequest |  (optional)

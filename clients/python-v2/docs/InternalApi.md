...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    repository = 'repository_example' # str | 
    commit_record_creation = lakefs_sdk_v2.CommitRecordCreation() # CommitRecordCreation | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    repository = 'repository_example' # str | 
    repository_metadata_keys = lakefs_sdk_v2.RepositoryMetadataKeys() # RepositoryMetadataKeys | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    repository = 'repository_example' # str | 
    branch_protection_rule = lakefs_sdk_v2.BranchProtectionRule() # BranchProtectionRule | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    repository = 'repository_example' # str | 
    internal_delete_branch_protection_rule_request = lakefs_sdk_v2.InternalDeleteBranchProtectionRuleRequest() # InternalDeleteBranchProtectionRuleRequest | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    repository = 'repository_example' # str | 
    garbage_collection_rules = lakefs_sdk_v2.GarbageCollectionRules() # GarbageCollectionRules | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    stats_events_list = lakefs_sdk_v2.StatsEventsList() # StatsEventsList | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # prepare gc commits
        api_response = api_instance.prepare_garbage_collection_commits_async(repository)
        print("The response of InternalApi->prepare_garbage_collection_commits_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternalApi->prepare_garbage_collection_commits_async: %s\n" % e)
```
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # get status of prepare gc commits operation
        api_response = api_instance.prepare_garbage_collection_commits_status(repository, id)
        print("The response of InternalApi->prepare_garbage_collection_commits_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternalApi->prepare_garbage_collection_commits_status: %s\n" % e)
```
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    repository = 'repository_example' # str | 
    prepare_gc_uncommitted_request = lakefs_sdk_v2.PrepareGCUncommittedRequest() # PrepareGCUncommittedRequest |  (optional)
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    repository = 'repository_example' # str | 
    refs_restore = lakefs_sdk_v2.RefsRestore() # RefsRestore | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    repository = 'repository_example' # str | 
    repository_metadata_set = lakefs_sdk_v2.RepositoryMetadataSet() # RepositoryMetadataSet | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    setup = lakefs_sdk_v2.Setup() # Setup | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_v2.InternalApi(api_client)
    comm_prefs_input = lakefs_sdk_v2.CommPrefsInput() # CommPrefsInput | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    object_stage_creation = lakefs_sdk_v2.ObjectStageCreation() # ObjectStageCreation | 

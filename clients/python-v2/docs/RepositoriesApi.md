...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.RepositoriesApi(api_client)
    repository_creation = lakefs_sdk_v2.RepositoryCreation() # RepositoryCreation | 
...
with lakefs_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_v2.RepositoriesApi(api_client)
    repository = 'repository_example' # str | 
    branch_protection_rule = [lakefs_sdk_v2.BranchProtectionRule()] # List[BranchProtectionRule] | 

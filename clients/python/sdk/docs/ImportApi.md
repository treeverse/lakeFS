...
with lakefs_sdk.ApiClient(configuration) as api_client:
    ...
    meta_range_creation = lakefs_sdk.MetaRangeCreation() # MetaRangeCreation | 

    try:
        # create a lakeFS metarange file from the given ranges
        api_response = api_instance.create_meta_range(repository, meta_range_creation)
        print("The response of ImportApi->create_meta_range:\n")
        pprint(api_response)
...
with lakefs_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk.ImportApi(api_client)
    repository = 'repository_example' # str | 
    stage_range_creation = lakefs_sdk.StageRangeCreation() # StageRangeCreation | 

    try:
        # create a lakeFS range file from the source uri
        api_response = api_instance.ingest_range(repository, stage_range_creation)
        print("The response of ImportApi->ingest_range:\n")
        pprint(api_response)
    except Exception as e:

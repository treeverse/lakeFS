...
with lakefs_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RetentionApi->get_garbage_collection_rules:\n")
        pprint(api_response)
    except Exception as e:
...
> GarbageCollectionPrepareResponse prepare_garbage_collection_commits(repository, garbage_collection_prepare_request=garbage_collection_prepare_request)
...
with lakefs_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk.RetentionApi(api_client)
    repository = 'repository_example' # str | 
    garbage_collection_prepare_request = lakefs_sdk.GarbageCollectionPrepareRequest() # GarbageCollectionPrepareRequest |  (optional)

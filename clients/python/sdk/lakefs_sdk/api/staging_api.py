...
class StagingApi(object):
    ...
    @validate_arguments
    def update_branch_token(self, repository : StrictStr, branch : StrictStr, update_token : UpdateToken, **kwargs) -> None:  # noqa: E501
        ...
        :param branch: (required)
        :type branch: str
        :param update_token: (required)
        :type update_token: UpdateToken
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the update_branch_token_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.update_branch_token_with_http_info(repository, branch, update_token, **kwargs)  # noqa: E501

    @validate_arguments
    def update_branch_token_with_http_info(self, repository : StrictStr, branch : StrictStr, update_token : UpdateToken, **kwargs) -> ApiResponse:  # noqa: E501
        """modify branch staging token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_branch_token_with_http_info(repository, branch, update_token, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_branch_token" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_token'] is not None:
            _body_params = _params['update_token']
        ...
        return self.api_client.call_api(
            '/repositories/{repository}/branches/{branch}/update_token', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,

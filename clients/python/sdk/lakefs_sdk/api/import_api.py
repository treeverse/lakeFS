...
class ImportApi(object):
    ...
    @validate_arguments
    def create_meta_range(self, repository : StrictStr, meta_range_creation : MetaRangeCreation, **kwargs) -> MetaRangeCreationResponse:  # noqa: E501
        ...
        :type repository: str
        :param meta_range_creation: (required)
        :type meta_range_creation: MetaRangeCreation
        ...
        :rtype: MetaRangeCreationResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the create_meta_range_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.create_meta_range_with_http_info(repository, meta_range_creation, **kwargs)  # noqa: E501

    @validate_arguments
    def create_meta_range_with_http_info(self, repository : StrictStr, meta_range_creation : MetaRangeCreation, **kwargs) -> ApiResponse:  # noqa: E501
        """create a lakeFS metarange file from the given ranges  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_meta_range_with_http_info(repository, meta_range_creation, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MetaRangeCreationResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_meta_range" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['meta_range_creation'] is not None:
            _body_params = _params['meta_range_creation']
        ...
        return self.api_client.call_api(
            '/repositories/{repository}/branches/metaranges', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def import_status(self, repository : StrictStr, branch : StrictStr, id : Annotated[StrictStr, Field(..., description="Unique identifier of the import process")], **kwargs) -> ImportStatusResp:  # noqa: E501
    ...
    def import_status_with_http_info(self, repository : StrictStr, branch : StrictStr, id : Annotated[StrictStr, Field(..., description="Unique identifier of the import process")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ImportStatusResp, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def ingest_range(self, repository : StrictStr, stage_range_creation : StageRangeCreation, **kwargs) -> IngestRangeCreationResponse:  # noqa: E501
        ...
        :param repository: (required)
        :type repository: str
        :param stage_range_creation: (required)
        :type stage_range_creation: StageRangeCreation
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: IngestRangeCreationResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the ingest_range_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.ingest_range_with_http_info(repository, stage_range_creation, **kwargs)  # noqa: E501

    @validate_arguments
    def ingest_range_with_http_info(self, repository : StrictStr, stage_range_creation : StageRangeCreation, **kwargs) -> ApiResponse:  # noqa: E501
        """create a lakeFS range file from the source uri  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.ingest_range_with_http_info(repository, stage_range_creation, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IngestRangeCreationResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        # process the body parameter
        _body_params = None
        if _params['stage_range_creation'] is not None:
            _body_params = _params['stage_range_creation']
        ...
        _response_types_map = {
            '201': "IngestRangeCreationResponse",
            '400': "Error",
            '401': "Error",
            '404': "Error",
        }
        ...
        return self.api_client.call_api(
            '/repositories/{repository}/branches/ranges', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,

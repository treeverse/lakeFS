...
class PolicyV2(BaseModel):
    ...
    statement: Optional[conlist(StatementV2, min_items=1)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolicyV2:
        """Create an instance of PolicyV2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyV2.parse_obj(obj)

        _obj = PolicyV2.parse_obj({
            "id": obj.get("id"),
            "creation_date": obj.get("creation_date"),
            "statement": [StatementV2.from_dict(_item) for _item in obj.get("statement")] if obj.get("statement") is not None else None
        })
        return _obj

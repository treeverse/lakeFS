...
class ObjectMoveCreation(BaseModel):
    """
    ObjectMoveCreation
    """
    src_path: StrictStr = Field(..., description="path of the moved object relative to the ref")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectMoveCreation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectMoveCreation:
        """Create an instance of ObjectMoveCreation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectMoveCreation.parse_obj(obj)

        _obj = ObjectMoveCreation.parse_obj({

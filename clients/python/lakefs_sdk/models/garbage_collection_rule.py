...
class GarbageCollectionRule(BaseModel):
    ...
    __properties = ["branch_id", "retention_days"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GarbageCollectionRule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GarbageCollectionRule:
        """Create an instance of GarbageCollectionRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GarbageCollectionRule.parse_obj(obj)

        _obj = GarbageCollectionRule.parse_obj({

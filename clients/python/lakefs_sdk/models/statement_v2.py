...
class StatementV2(BaseModel):
    """
    StatementV2
    """
    effect: StrictStr = Field(...)
    resource: conlist(StrictStr, min_items=1) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StatementV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StatementV2:
        """Create an instance of StatementV2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StatementV2.parse_obj(obj)

        _obj = StatementV2.parse_obj({

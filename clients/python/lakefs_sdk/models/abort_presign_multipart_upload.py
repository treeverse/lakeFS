...
class AbortPresignMultipartUpload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbortPresignMultipartUpload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbortPresignMultipartUpload:
        """Create an instance of AbortPresignMultipartUpload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AbortPresignMultipartUpload.parse_obj(obj)

        _obj = AbortPresignMultipartUpload.parse_obj({

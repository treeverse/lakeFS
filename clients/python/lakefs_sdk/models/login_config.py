...
class LoginConfig(BaseModel):
    ...
    select_login_method: Optional[StrictBool] = Field(None, description="When set to true, displays a login page that lets the user choose a preferred authentication method for  logging into lakeFS. Either via SSO (using the login_url field, which needs to be configured) or using  lakeFS credentials. ")
    ...
    __properties = ["RBAC", "select_login_method", "username_ui_placeholder", "password_ui_placeholder", "login_url", "login_failed_message", "fallback_login_url", "fallback_login_label", "login_cookie_names", "logout_url", "use_login_placeholders"]
    ...
    def from_dict(cls, obj: dict) -> LoginConfig:
        ...
        _obj = LoginConfig.parse_obj({
            "rbac": obj.get("RBAC"),
            "select_login_method": obj.get("select_login_method"),

...
class ExperimentalApi:
    ...
    def upload_part_from(self, repository : StrictStr, branch : StrictStr, upload_id : StrictStr, path : StrictStr, part_number : conint(strict=True, le=1000, ge=1), upload_part_from : Optional[UploadPartFrom] = None, **kwargs) -> UploadTo:  # noqa: E501
        ...
        >>> thread = api.upload_part_from(repository, branch, upload_id, path, part_number, upload_part_from, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the upload_part_from_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.upload_part_from_with_http_info(repository, branch, upload_id, path, part_number, upload_part_from, **kwargs)  # noqa: E501
    ...
    def upload_part_from_with_http_info(self, repository : StrictStr, branch : StrictStr, upload_id : StrictStr, path : StrictStr, part_number : conint(strict=True, le=1000, ge=1), upload_part_from : Optional[UploadPartFrom] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.upload_part_from_with_http_info(repository, branch, upload_id, path, part_number, upload_part_from, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_part_from" % _key
                )
            _params[_key] = _val
        del _params['kwargs']

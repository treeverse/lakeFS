...
class ObjectsApi:
    ...
    @validate_arguments
    def move_object(self, repository : StrictStr, branch : Annotated[StrictStr, Field(..., description="destination branch for the move")], dest_path : Annotated[StrictStr, Field(..., description="destination path relative to the branch")], object_move_creation : ObjectMoveCreation, **kwargs) -> ObjectStats:  # noqa: E501
        """move an object from one path to another  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.move_object(repository, branch, dest_path, object_move_creation, async_req=True)
        >>> result = thread.get()
        ...
        :param dest_path: destination path relative to the branch (required)
        :type dest_path: str
        :param object_move_creation: (required)
        :type object_move_creation: ObjectMoveCreation
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the move_object_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.move_object_with_http_info(repository, branch, dest_path, object_move_creation, **kwargs)  # noqa: E501

    @validate_arguments
    def move_object_with_http_info(self, repository : StrictStr, branch : Annotated[StrictStr, Field(..., description="destination branch for the move")], dest_path : Annotated[StrictStr, Field(..., description="destination path relative to the branch")], object_move_creation : ObjectMoveCreation, **kwargs) -> ApiResponse:  # noqa: E501
        """move an object from one path to another  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.move_object_with_http_info(repository, branch, dest_path, object_move_creation, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['object_move_creation'] is not None:
            _body_params = _params['object_move_creation']
        ...
        return self.api_client.call_api(
            '/repositories/{repository}/branches/{branch}/objects/move', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,

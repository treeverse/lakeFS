...
class ActionsApi:
    ...
    @validate_arguments
    def trigger_action(self, repository : StrictStr, ref : StrictStr, action : StrictStr, **kwargs) -> None:  # noqa: E501
        """manually trigger an action  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.trigger_action(repository, ref, action, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the trigger_action_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.trigger_action_with_http_info(repository, ref, action, **kwargs)  # noqa: E501

    @validate_arguments
    def trigger_action_with_http_info(self, repository : StrictStr, ref : StrictStr, action : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """manually trigger an action  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.trigger_action_with_http_info(repository, ref, action, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/repositories/{repository}/refs/{ref}/actions/{action}/triggers', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,

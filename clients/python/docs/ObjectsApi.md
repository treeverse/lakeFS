...
[**upload_object_preflight**](ObjectsApi.md#upload_object_preflight) | **OPTIONS** /repositories/{repository}/branches/{branch}/objects | 
...
with lakefs_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ObjectsApi->upload_object_preflight: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**204** | user has permissions to upload an object |  -  |
**401** | Unauthorized |  -  |
**403** | Forbidden |  -  |
**404** | Resource Not Found |  -  |
**0** | Internal Server Error |  -  |

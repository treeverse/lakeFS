...
# **move_object**
> ObjectStats move_object(repository, branch, dest_path, object_move_creation)
...
with lakefs_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk.ObjectsApi(api_client)
    repository = 'repository_example' # str | 
    branch = 'branch_example' # str | destination branch for the move
    dest_path = 'dest_path_example' # str | destination path relative to the branch
    object_move_creation = lakefs_sdk.ObjectMoveCreation() # ObjectMoveCreation | 

    try:
        # move an object from one path to another
        api_response = api_instance.move_object(repository, branch, dest_path, object_move_creation)
        print("The response of ObjectsApi->move_object:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectsApi->move_object: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **repository** | **str**|  | 
 **branch** | **str**| destination branch for the move | 
 **dest_path** | **str**| destination path relative to the branch | 
 **object_move_creation** | [**ObjectMoveCreation**](ObjectMoveCreation.md)|  | 

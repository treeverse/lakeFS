...
[**otf_diffs**](OtfDiffApi.md#otf_diffs) | **GET** /otf/diffs | get the available OTF diffs
...
with lakefs_client.ApiClient(configuration) as api_client:
    ...
    try:
        # get the available OTF diffs
        api_response = api_instance.otf_diffs()
        pprint(api_response)
    except lakefs_client.ApiException as e:
        print("Exception when calling OtfDiffApi->otf_diffs: %s\n" % e)
```

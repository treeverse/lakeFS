...
[**hard_reset_branch**](BranchesApi.md#hard_reset_branch) | **PUT** /repositories/{repository}/branches/{branch}/hard_reset | hard reset branch
...
with lakefs_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling BranchesApi->hard_reset_branch: %s\n" % e)
```

...
------------- | ------------- | -------------
[**cherry_pick**](BranchesApi.md#cherry_pick) | **POST** /repositories/{repository}/branches/{branch}/cherry-pick | Cherry-Pick the given reference commit into the given branch
...
# **cherry_pick**
> cherry_pick(repository, branch, cherry_pick_creation)
...
with lakefs_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Cherry-Pick the given reference commit into the given branch
        api_instance.cherry_pick(repository, branch, cherry_pick_creation)

...
# **get_policy_v2**
> PolicyV2 get_policy_v2(policy_id)
...
with lakefs_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # get policy with resources list
        api_response = api_instance.get_policy_v2(policy_id)
        print("The response of AuthApi->get_policy_v2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuthApi->get_policy_v2: %s\n" % e)
```

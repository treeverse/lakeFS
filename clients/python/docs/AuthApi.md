...
[**update_username_and_password**](AuthApi.md#update_username_and_password) | **POST** /auth/username/password | Update username and password by reset_password token
...
> update_username_and_password(update_username_and_password_with_token)
...
with lakefs_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update username and password by reset_password token
        api_instance.update_username_and_password(update_username_and_password_with_token)
    except lakefs_client.ApiException as e:
        print("Exception when calling AuthApi->update_username_and_password: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **update_username_and_password_with_token** | [**UpdateUsernameAndPasswordWithToken**](UpdateUsernameAndPasswordWithToken.md)|  |

...
with lakefs_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CommitsApi->commit_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CommitsApi->commit_async: %s\n" % e)
```
...
# **commit_status**
> CommitAsyncStatus commit_status(repository, branch, id)

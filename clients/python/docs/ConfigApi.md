...
------------- | ------------- | -------------
[**get_email_config**](ConfigApi.md#get_email_config) | **GET** /config/emailer | 
...
# **get_email_config**
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} get_email_config()
...
with lakefs_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ConfigApi->get_email_config: %s\n" % e)
```

...
[**get_s3_gateway_config**](ConfigApi.md#get_s3_gateway_config) | **GET** /config/gateway/s3 | 
...
# **get_s3_gateway_config**
> S3GatewayConfig get_s3_gateway_config()
...
with lakefs_client.ApiClient(configuration) as api_client:
    ...
    # example, this endpoint has no required or optional parameters
    try:
        api_response = api_instance.get_s3_gateway_config()
        pprint(api_response)
    except lakefs_client.ApiException as e:
        print("Exception when calling ConfigApi->get_s3_gateway_config: %s\n" % e)
```

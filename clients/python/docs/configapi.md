...
| :--- | :--- | :--- |
| [**get\_lake\_fs\_version**](configapi.md#get_lake_fs_version) | **GET** /config/version |  |
...
## **get\_lake\_fs\_version**

> VersionConfig get\_lake\_fs\_version\(\)
...
* Bearer \(JWT\) Authentication \(jwt\_token\):
  ...
  from lakefs\_client.model.version\_config import VersionConfig

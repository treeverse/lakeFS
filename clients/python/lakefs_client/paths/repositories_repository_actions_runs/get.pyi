...
CommitSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'commit': typing.Union[CommitSchema, str, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = ActionRunList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_repository_runs_oapg(
        self,
...
class ListRepositoryRuns(BaseApi):
    ...
    def list_repository_runs(
        ...
        return self._list_repository_runs_oapg(

...
# Query params
TablePathSchema = schemas.StrSchema
TypeSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'table_path': typing.Union[TablePathSchema, str, ],
...
request_query_table_path = api_client.QueryParameter(
    name="table_path",
    style=api_client.ParameterStyle.FORM,
    schema=TablePathSchema,
    required=True,
    explode=True,
)
...
LeftRefSchema = schemas.StrSchema
RightRefSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'repository': typing.Union[RepositorySchema, str, ],
        'left_ref': typing.Union[LeftRefSchema, str, ],
        'right_ref': typing.Union[RightRefSchema, str, ],
    }
)
...
request_path_left_ref = api_client.PathParameter(
    name="left_ref",
    style=api_client.ParameterStyle.SIMPLE,
    schema=LeftRefSchema,
    required=True,
)
request_path_right_ref = api_client.PathParameter(
    name="right_ref",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RightRefSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = OtfDiffList
...
class BaseApi(api_client.Api):
    ...
    def _otf_diff_oapg(
        ...
        for parameter in (
            ...
            request_path_left_ref,
            request_path_right_ref,
        ):

...
SchemaFor200ResponseBodyApplicationJson = AuthCapabilities
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_auth_capabilities_oapg(
        self,
...
class GetAuthCapabilities(BaseApi):
    ...
    def get_auth_capabilities(
        ...
        return self._get_auth_capabilities_oapg(

...
SchemaFor200ResponseBodyApplicationJson = GarbageCollectionConfig
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_garbage_collection_config_oapg(
        self,
...
class GetGarbageCollectionConfig(BaseApi):
    ...
    def get_garbage_collection_config(
        ...
        return self._get_garbage_collection_config_oapg(

...
LastModifiedSchema = schemas.StrSchema
ETagSchema = schemas.StrSchema
SchemaFor206ResponseBodyApplicationOctetStream = schemas.BinarySchema
...
_response_for_206 = api_client.OpenApiResponse(
    ...
    content={
        'application/octet-stream': api_client.MediaType(
            schema=SchemaFor206ResponseBodyApplicationOctetStream),
    },
    headers=[
        content_length_parameter,
...
SchemaFor416ResponseBodyApplicationJson = Error

...
# body param
SchemaForRequestBodyApplicationJson = MetaRangeCreation


request_body_meta_range_creation = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = MetaRangeCreationResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_meta_range_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_meta_range_creation.serialize(body, content_type)
...
class CreateMetaRange(BaseApi):
    ...
    def create_meta_range(
        ...
        return self._create_meta_range_oapg(
            body=body,

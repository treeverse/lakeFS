...
# body param
SchemaForRequestBodyApplicationJson = CherryPickCreation


request_body_cherry_pick_creation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _cherry_pick_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cherry_pick_creation.serialize(body, content_type)

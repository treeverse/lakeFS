...
# Path params
TemplateLocationSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'template_location': typing.Union[TemplateLocationSchema, str, ],
    }
)
...
request_path_template_location = api_client.PathParameter(
    name="template_location",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TemplateLocationSchema,
    required=True,
)
_auth = [
    'basic_auth',
...
class BaseApi(api_client.Api):
    ...
    def _expand_template_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_template_location,
        ):
...
class ExpandTemplate(BaseApi):
    ...
    def expand_template(
        ...
        return self._expand_template_oapg(

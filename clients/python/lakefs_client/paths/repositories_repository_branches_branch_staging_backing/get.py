...
SchemaFor200ResponseBodyApplicationJson = StagingLocation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_physical_address_oapg(
        self,
...
class GetPhysicalAddress(BaseApi):
    ...
    def get_physical_address(
        ...
        return self._get_physical_address_oapg(

...
SchemaFor200ResponseBodyApplicationJson = GarbageCollectionRules
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_garbage_collection_rules_oapg(
        self,
...
class GetGarbageCollectionRules(BaseApi):
    ...
    def get_garbage_collection_rules(
        ...
        return self._get_garbage_collection_rules_oapg(

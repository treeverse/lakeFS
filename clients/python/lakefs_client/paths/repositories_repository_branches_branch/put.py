...
# body param
SchemaForRequestBodyApplicationJson = ResetCreation


request_body_reset_creation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _reset_branch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_reset_creation.serialize(body, content_type)
...
class ResetBranch(BaseApi):
    ...
    def reset_branch(
        ...
        return self._reset_branch_oapg(
            body=body,

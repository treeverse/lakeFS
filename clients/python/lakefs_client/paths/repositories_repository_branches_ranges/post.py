...
# body param
SchemaForRequestBodyApplicationJson = StageRangeCreation


request_body_stage_range_creation = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = IngestRangeCreationResponse
...
class BaseApi(api_client.Api):
    ...
    def _ingest_range_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_stage_range_creation.serialize(body, content_type)
...
class IngestRange(BaseApi):
    ...
    def ingest_range(
        ...
        return self._ingest_range_oapg(
            body=body,

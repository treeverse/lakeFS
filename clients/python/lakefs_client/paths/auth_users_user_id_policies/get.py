...
class AmountSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = -1
EffectiveSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'effective': typing.Union[EffectiveSchema, bool, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = PolicyList
...
class ListUserPolicies(BaseApi):
    ...
    def list_user_policies(
        ...
        return self._list_user_policies_oapg(

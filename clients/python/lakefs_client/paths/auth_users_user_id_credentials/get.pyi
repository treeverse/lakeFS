...
SchemaFor200ResponseBodyApplicationJson = CredentialsList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_user_credentials_oapg(
        self,
...
class ListUserCredentials(BaseApi):
    ...
    def list_user_credentials(
        ...
        return self._list_user_credentials_oapg(

...
SchemaFor201ResponseBodyApplicationJson = CredentialsWithSecret
...
class CreateCredentials(BaseApi):
    ...
    def create_credentials(
        ...
        return self._create_credentials_oapg(

...
CommitIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'repository': typing.Union[RepositorySchema, str, ],
        'commitId': typing.Union[CommitIdSchema, str, ],
    }
)
...
request_path_commit_id = api_client.PathParameter(
    name="commitId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CommitIdSchema,
    required=True,
)

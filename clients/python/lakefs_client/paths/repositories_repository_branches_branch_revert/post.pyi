...
# body param
SchemaForRequestBodyApplicationJson = RevertCreation


request_body_revert_creation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _revert_branch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_revert_creation.serialize(body, content_type)
...
class RevertBranch(BaseApi):
    ...
    def revert_branch(
        ...
        return self._revert_branch_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = Setup


request_body_setup = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CredentialsWithSecret
...
class BaseApi(api_client.Api):
    ...
    def _setup_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_setup.serialize(body, content_type)

...
MetaRangeSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'repository': typing.Union[RepositorySchema, str, ],
        'meta_range': typing.Union[MetaRangeSchema, str, ],
    }
)
...
request_path_meta_range = api_client.PathParameter(
    name="meta_range",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MetaRangeSchema,
    required=True,
)
LocationSchema = schemas.StrSchema
SchemaFor200ResponseBodyApplicationJson = StorageURI
...
class GetMetaRange(BaseApi):
    ...
    def get_meta_range(
        ...
        return self._get_meta_range_oapg(

...
# Query params
SourceMetarangeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'source_metarange': typing.Union[SourceMetarangeSchema, str, ],
    },
    total=False
)
...
request_query_source_metarange = api_client.QueryParameter(
    name="source_metarange",
    style=api_client.ParameterStyle.FORM,
    schema=SourceMetarangeSchema,
    explode=True,
)
# Path params
...
# body param
SchemaForRequestBodyApplicationJson = CommitCreation


request_body_commit_creation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _commit_oapg(
        ...
        for parameter in (
            request_query_source_metarange,
        ):
        ...
        _fields = None
        _body = None
        serialized_data = request_body_commit_creation.serialize(body, content_type)

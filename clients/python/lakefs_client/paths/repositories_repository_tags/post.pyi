...
# body param
SchemaForRequestBodyApplicationJson = TagCreation


request_body_tag_creation = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Ref
...
class BaseApi(api_client.Api):
    ...
    def _create_tag_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_creation.serialize(body, content_type)

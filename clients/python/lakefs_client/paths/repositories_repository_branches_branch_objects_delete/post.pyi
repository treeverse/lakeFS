...
# body param
SchemaForRequestBodyApplicationJson = PathList


request_body_path_list = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ObjectErrorList
...
class BaseApi(api_client.Api):
    ...
    def _delete_objects_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_path_list.serialize(body, content_type)
...
class DeleteObjects(BaseApi):
    ...
    def delete_objects(
        ...
        return self._delete_objects_oapg(
            body=body,

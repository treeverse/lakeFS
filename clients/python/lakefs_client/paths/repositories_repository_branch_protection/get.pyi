...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BranchProtectionRule']:
            return BranchProtectionRule

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['BranchProtectionRule'], typing.List['BranchProtectionRule']],
    ...
    def __getitem__(self, i: int) -> 'BranchProtectionRule':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_branch_protection_rules_oapg(
        self,
...
class GetBranchProtectionRules(BaseApi):
    ...
    def get_branch_protection_rules(
        ...
        return self._get_branch_protection_rules_oapg(

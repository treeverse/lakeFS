...
# body param
SchemaForRequestBodyApplicationJson = GarbageCollectionPrepareRequest


request_body_garbage_collection_prepare_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = GarbageCollectionPrepareResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _prepare_garbage_collection_commits_oapg(
        self,
    ...
    def _prepare_garbage_collection_commits_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_garbage_collection_prepare_request.serialize(body, content_type)
...
class PrepareGarbageCollectionCommits(BaseApi):
    ...
    def prepare_garbage_collection_commits(
        ...
        return self._prepare_garbage_collection_commits_oapg(
            body=body,

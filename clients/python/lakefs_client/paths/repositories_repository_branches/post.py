...
# body param
SchemaForRequestBodyApplicationJson = BranchCreation


request_body_branch_creation = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextHtml = schemas.StrSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_branch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_branch_creation.serialize(body, content_type)

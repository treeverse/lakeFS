...
SourceRefSchema = schemas.StrSchema
DestinationBranchSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'repository': typing.Union[RepositorySchema, str, ],
        'sourceRef': typing.Union[SourceRefSchema, str, ],
        'destinationBranch': typing.Union[DestinationBranchSchema, str, ],
    }
)
...
request_path_source_ref = api_client.PathParameter(
    name="sourceRef",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SourceRefSchema,
    required=True,
)
request_path_destination_branch = api_client.PathParameter(
    name="destinationBranch",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DestinationBranchSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = Merge


request_body_merge = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MergeResult
...
SchemaFor409ResponseBodyApplicationJson = MergeResult
...
class BaseApi(api_client.Api):
    ...
    def _merge_into_branch_oapg(
        ...
        for parameter in (
            ...
            request_path_source_ref,
            request_path_destination_branch,
        ):
        ...
        if body is not schemas.unset:
            serialized_data = request_body_merge.serialize(body, content_type)
...
class MergeIntoBranch(BaseApi):
    ...
    def merge_into_branch(
        ...
        return self._merge_into_branch_oapg(
            body=body,

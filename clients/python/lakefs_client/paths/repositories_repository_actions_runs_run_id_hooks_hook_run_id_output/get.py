...
request_path_hook_run_id = api_client.PathParameter(
    name="hook_run_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=HookRunIdSchema,
    required=True,
)
_auth = [
    'basic_auth',
...
class GetRunHookOutput(BaseApi):
    ...
    def get_run_hook_output(
        ...
        return self._get_run_hook_output_oapg(

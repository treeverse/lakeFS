...
# body param
SchemaForRequestBodyApplicationJson = PrepareGCUncommittedRequest


request_body_prepare_gc_uncommitted_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = PrepareGCUncommittedResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _prepare_garbage_collection_uncommitted_oapg(
        self,
    ...
    def _prepare_garbage_collection_uncommitted_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_prepare_gc_uncommitted_request.serialize(body, content_type)
...
class PrepareGarbageCollectionUncommitted(BaseApi):
    ...
    def prepare_garbage_collection_uncommitted(
        ...
        return self._prepare_garbage_collection_uncommitted_oapg(
            body=body,

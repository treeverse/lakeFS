...
# body param
SchemaForRequestBodyApplicationJson = LoginInformation


request_body_login_information = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _login_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_login_information.serialize(body, content_type)

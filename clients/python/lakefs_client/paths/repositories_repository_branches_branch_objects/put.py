...
# body param
SchemaForRequestBodyApplicationJson = ObjectStageCreation


request_body_object_stage_creation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _stage_object_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_object_stage_creation.serialize(body, content_type)
...
class StageObject(BaseApi):
    ...
    def stage_object(
        ...
        return self._stage_object_oapg(
            body=body,

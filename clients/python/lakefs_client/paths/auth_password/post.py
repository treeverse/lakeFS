...
# body param
SchemaForRequestBodyApplicationJson = UpdatePasswordByToken


request_body_update_password_by_token = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_password_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_password_by_token.serialize(body, content_type)

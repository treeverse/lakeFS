...
class PrefixesSchema(
    ...
    def __getitem__(self, i: int) -> MetaOapg.items:
        return super().__getitem__(i)
LimitSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'objects': typing.Union[ObjectsSchema, list, tuple, ],
        'prefixes': typing.Union[PrefixesSchema, list, tuple, ],
        'limit': typing.Union[LimitSchema, bool, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = CommitList

...
# body param
SchemaForRequestBodyApplicationJson = GroupCreation


request_body_group_creation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_group_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_group_creation.serialize(body, content_type)

...
SchemaFor200ResponseBodyApplicationJson = UnderlyingObjectProperties
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_underlying_properties_oapg(
        self,
...
class GetUnderlyingProperties(BaseApi):
    ...
    def get_underlying_properties(
        ...
        return self._get_underlying_properties_oapg(

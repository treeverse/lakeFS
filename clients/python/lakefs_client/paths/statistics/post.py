...
# body param
SchemaForRequestBodyApplicationJson = StatsEventsList


request_body_stats_events_list = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_stats_events_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_stats_events_list.serialize(body, content_type)
...
class PostStatsEvents(BaseApi):
    ...
    def post_stats_events(
        ...
        return self._post_stats_events_oapg(
            body=body,

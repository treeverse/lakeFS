...
# body param
SchemaForRequestBodyApplicationJson = RefsDump


request_body_refs_dump = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _restore_refs_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_refs_dump.serialize(body, content_type)
...
class RestoreRefs(BaseApi):
    ...
    def restore_refs(
        ...
        return self._restore_refs_oapg(
            body=body,

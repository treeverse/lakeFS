...
class RetentionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.prepare_garbage_collection_uncommitted_endpoint = _Endpoint(
            settings={
                'response_type': (GarbageCollectionPrepareUncommittedResponse,),
                'auth': [
                    'basic_auth',
                    'cookie_auth',
                    'jwt_token',
                ...
                'endpoint_path': '/repositories/{repository}/gc/prepare_uncommitted',
            ...
            params_map={
                'all': [
                    'repository',
                    'garbage_collection_prepare_uncommitted_request',
                ],
                'required': [
                    'repository',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'repository': 'path',
                    'garbage_collection_prepare_uncommitted_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def prepare_garbage_collection_uncommitted(
        ...
        **kwargs
        ...
        """save lists of uncommitted objects for garbage collection  # noqa: E501
        ...
        Keyword Args:
            garbage_collection_prepare_uncommitted_request (GarbageCollectionPrepareUncommittedRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.

...
class ConfigApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_email_config_endpoint = _Endpoint(
            settings={
    ...
    def get_email_config(
        ...
        **kwargs
        ...
        retrieve emailer config  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_email_config(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_email_config_endpoint.call_with_http_info(**kwargs)

...
class ConfigApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_s3_gateway_config_endpoint = _Endpoint(
            settings={
                'response_type': (S3GatewayConfig,),
                'auth': [
                    'basic_auth',
                    'cookie_auth',
                    'jwt_token',
                ...
                'endpoint_path': '/config/gateway/s3',
                'operation_id': 'get_s3_gateway_config',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_s3_gateway_config(
        self,
        **kwargs
    ):
        """get_s3_gateway_config  # noqa: E501

        retrieve S3 Gateway information from lakeFS  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_s3_gateway_config(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_s3_gateway_config_endpoint.call_with_http_info(**kwargs)

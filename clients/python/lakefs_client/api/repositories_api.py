...
class RepositoriesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_branch_protection_rule(
            self,
            repository,
        ...
        self.create_branch_protection_rule = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basic_auth',
            ...
            callable=__create_branch_protection_rule
        )
        ...
        def __delete_branch_protection_rule(
            self,
            repository,
            inline_object1,
            **kwargs
        ...
        self.delete_branch_protection_rule = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basic_auth',
            ...
            api_client=api_client,
            callable=__delete_branch_protection_rule
        )
        ...
        def __get_branch_protection_rules(
            self,
            repository,
            **kwargs
        ):
        ...
        self.get_branch_protection_rules = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_branch_protection_rules
        )
        ...
        def __set_branch_protection_rules(
            self,
            repository,
            branch_protection_rule,
            **kwargs
        ...
        self.set_branch_protection_rules = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basic_auth',
            ...
            api_client=api_client,
            callable=__set_branch_protection_rules
        )

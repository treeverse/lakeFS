...
class ImportPath(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, path, destination, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, path, destination, type, *args, **kwargs):  # noqa: E501
        """ImportPath - a model defined in OpenAPI

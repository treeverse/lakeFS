...
class UpdatePasswordByToken(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["token", "newPassword", "email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["token", "newPassword", "email", ], str]):

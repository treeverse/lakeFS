...
class ObjectError(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status_code", "message", "path", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status_code", "message", "path", ], str]):

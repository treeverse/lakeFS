...
class StagingLocation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["token", "physical_address", "presigned_url", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["physical_address"]) -> typing.Union[MetaOapg.properties.physical_address, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["token", "physical_address", "presigned_url", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        physical_address: typing.Union[MetaOapg.properties.physical_address, str, schemas.Unset] = schemas.unset,

...
class AccessKeyCredentials(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_key_id", "secret_access_key", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_key_id", "secret_access_key", ], str]):

...
class MetaRangeCreation(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ranges': ([RangeMetadata],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ranges, *args, **kwargs):  # noqa: E501
        """MetaRangeCreation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, ranges, *args, **kwargs):  # noqa: E501
        """MetaRangeCreation - a model defined in OpenAPI

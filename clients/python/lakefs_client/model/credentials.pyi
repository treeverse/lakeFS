...
class Credentials(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_key_id", "creation_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_key_id", "creation_date", ], str]):

...
class Ref(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "commit_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "commit_id", ], str]):

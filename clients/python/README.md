...
If the OpenAPI document is large, imports in lakefs.apis and lakefs.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from lakefs.api.default_api import DefaultApi`
- `from lakefs.model.pet import Pet`

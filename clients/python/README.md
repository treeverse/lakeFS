...
*RetentionApi* | [**prepare_retention_commits**](docs/RetentionApi.md#prepare_retention_commits) | **POST** /repositories/{repository}/gc/prepare | save lists of active and expired commits for garbage collection

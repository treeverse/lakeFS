...
*RetentionApi* | [**prepareRetentionCommits**](docs/RetentionApi.md#prepareRetentionCommits) | **POST** /repositories/{repository}/gc/prepare | save lists of active and expired commits for garbage collection

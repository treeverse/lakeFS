...
public class OtfDiffList {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OtfDiffList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OtfDiffList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null

...
public class OtfDiffEntry {
  ...
  **/
   ...
   * @return the OtfDiffEntry instance itself
   */
  public OtfDiffEntry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, otfDiffEntry.id) &&
        ...
        Objects.equals(this.additionalProperties, otfDiffEntry.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, operation, operationContent, operationType, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to OtfDiffEntry
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OtfDiffEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OtfDiffEntry>() {
           ...
           public OtfDiffEntry read(JsonReader in) throws IOException {
             ...
             OtfDiffEntry instance = thisAdapter.fromJsonTree(jsonObj);

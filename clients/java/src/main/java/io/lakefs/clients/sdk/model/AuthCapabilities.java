...
public class AuthCapabilities {
  ...
  public AuthCapabilities inviteUser(@javax.annotation.Nullable Boolean inviteUser) {
  ...
  public AuthCapabilities forgotPassword(@javax.annotation.Nullable Boolean forgotPassword) {
  ...
  public void setForgotPassword(@javax.annotation.Nullable Boolean forgotPassword) {
    this.forgotPassword = forgotPassword;
  }

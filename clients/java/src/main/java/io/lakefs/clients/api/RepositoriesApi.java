...
public class RepositoriesApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> set branch protection rules successfully </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resource Not Found </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Internal Server Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call setBranchProtectionRulesCall(String repository, List<BranchProtectionRule> branchProtectionRule, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = branchProtectionRule;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setBranchProtectionRulesValidateBeforeCall(String repository, List<BranchProtectionRule> branchProtectionRule, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setBranchProtectionRulesCall(repository, branchProtectionRule, _callback);
        return localVarCall;
     ...
     */
    public void setBranchProtectionRules(String repository, List<BranchProtectionRule> branchProtectionRule) throws ApiException {
        setBranchProtectionRulesWithHttpInfo(repository, branchProtectionRule);
    }
     ...
     */
    public ApiResponse<Void> setBranchProtectionRulesWithHttpInfo(String repository, List<BranchProtectionRule> branchProtectionRule) throws ApiException {
        okhttp3.Call localVarCall = setBranchProtectionRulesValidateBeforeCall(repository, branchProtectionRule, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call setBranchProtectionRulesAsync(String repository, List<BranchProtectionRule> branchProtectionRule, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = setBranchProtectionRulesValidateBeforeCall(repository, branchProtectionRule, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}

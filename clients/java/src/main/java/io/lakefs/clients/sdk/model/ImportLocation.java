...
public class ImportLocation {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImportLocation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImportLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null

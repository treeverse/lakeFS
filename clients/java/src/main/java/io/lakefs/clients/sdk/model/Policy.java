...
public class Policy {
  ...
  public Policy creationDate(@javax.annotation.Nullable Long creationDate) {
  ...
  public Policy statement(@javax.annotation.Nonnull List<Statement> statement) {
  ...
  public void setStatement(@javax.annotation.Nonnull List<Statement> statement) {
    this.statement = statement;
  }

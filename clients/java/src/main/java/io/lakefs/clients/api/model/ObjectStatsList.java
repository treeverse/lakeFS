...
public class ObjectStatsList {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ObjectStatsList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ObjectStatsList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ObjectStatsList.openapiFields.contains(entry.getKey())) {

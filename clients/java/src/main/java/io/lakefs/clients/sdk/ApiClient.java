...
import io.lakefs.clients.sdk.auth.Authentication;
...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("lakefs-java-sdk/0.0.0-v1");
     ...
     * @return a {@link io.lakefs.clients.sdk.ApiClient} object
     */
     ...
     * @throws io.lakefs.clients.sdk.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.lakefs.clients.sdk.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.lakefs.clients.sdk.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.lakefs.clients.sdk.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.lakefs.clients.sdk.ApiException If the response has an unsuccessful status code or
     ...
     * @param uri URI
     * @throws io.lakefs.clients.sdk.ApiException If fails to update the parameters
     */
     ...
     * @throws io.lakefs.clients.sdk.ApiException If fail to serialize the request body object into a string
     */

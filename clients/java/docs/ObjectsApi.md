...
| [**moveObject**](ObjectsApi.md#moveObject) | **POST** /repositories/{repository}/branches/{branch}/objects/move | move an object from one path to another |
...
<a id="moveObject"></a>
# **moveObject**
> ObjectStats moveObject(repository, branch, destPath, objectMoveCreation).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectsApi apiInstance = new ObjectsApi(defaultClient);
    String repository = "repository_example"; // String | 
    String branch = "branch_example"; // String | destination branch for the move
    String destPath = "destPath_example"; // String | destination path relative to the branch
    ObjectMoveCreation objectMoveCreation = new ObjectMoveCreation(); // ObjectMoveCreation | 
    try {
      ObjectStats result = apiInstance.moveObject(repository, branch, destPath, objectMoveCreation)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ObjectsApi#moveObject");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|------------- | ------------- | ------------- | -------------|
| **repository** | **String**|  | |
| **branch** | **String**| destination branch for the move | |
| **destPath** | **String**| destination path relative to the branch | |
| **objectMoveCreation** | [**ObjectMoveCreation**](ObjectMoveCreation.md)|  | |

...
[**getS3GatewayConfig**](ConfigApi.md#getS3GatewayConfig) | **GET** /config/gateway/s3 | 
...
<a name="getS3GatewayConfig"></a>
# **getS3GatewayConfig**
> S3GatewayConfig getS3GatewayConfig()
...
public class Example {
  public static void main(String[] args) {
    ...
    ConfigApi apiInstance = new ConfigApi(defaultClient);
    try {
      S3GatewayConfig result = apiInstance.getS3GatewayConfig();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ConfigApi#getS3GatewayConfig");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**S3GatewayConfig**](S3GatewayConfig.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | lakeFS S3 Gateway configuration |  -  |
**401** | Unauthorized |  -  |

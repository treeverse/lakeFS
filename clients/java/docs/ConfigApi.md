...
------------- | ------------- | -------------
[**getEmailConfig**](ConfigApi.md#getEmailConfig) | **GET** /config/emailer | 
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getEmailConfig();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ConfigApi#getEmailConfig");

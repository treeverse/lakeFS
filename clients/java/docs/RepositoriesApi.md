...
[**setBranchProtectionRules**](RepositoriesApi.md#setBranchProtectionRules) | **POST** /repositories/{repository}/branch_protection | 
...
> setBranchProtectionRules(repository, branchProtectionRule)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**204** | set branch protection rules successfully |  -  |
**401** | Unauthorized |  -  |
**404** | Resource Not Found |  -  |
**0** | Internal Server Error |  -  |

...
[**createBranchProtectionRulePreflight**](RepositoriesApi.md#createBranchProtectionRulePreflight) | **GET** /repositories/{repository}/branch_protection/set_allowed | 
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling RepositoriesApi#createBranchProtectionRule");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling RepositoriesApi#createBranchProtectionRulePreflight");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> deleteBranchProtectionRule(repository, inlineObject)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteBranchProtectionRule(repository, inlineObject);
    } catch (ApiException e) {
...
> Map&lt;String, String&gt; getRepositoryMetadata(repository)

...
| [**getPolicyV2**](AuthApi.md#getPolicyV2) | **GET** /auth/policiesV2/{policyId} | get policy with resources list |
...
<a id="getPolicyV2"></a>
# **getPolicyV2**
> PolicyV2 getPolicyV2(policyId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String policyId = "policyId_example"; // String | 
    try {
      PolicyV2 result = apiInstance.getPolicyV2(policyId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AuthApi#getPolicyV2");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();

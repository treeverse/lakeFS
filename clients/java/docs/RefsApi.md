...
<a id="diffRefs"></a>
# **diffRefs**
> DiffList diffRefs(repository, leftRef, rightRef).after(after).amount(amount).prefix(prefix).delimiter(delimiter).type(type).includeRight(includeRight).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean includeRight = false; // Boolean | If set to true, the diff will include system and user object info. *EXPERIMENTAL*
    try {
...
| **includeRight** | **Boolean**| If set to true, the diff will include system and user object info. *EXPERIMENTAL* | [optional] [default to false] |

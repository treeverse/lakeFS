    ...
    describe(".listCommittedAddresses") {
      it("should successfully call prepareGarbageCollectionCommits and process result") {
        ...
        try {
          ...
          Mockito
            .when(
              mockClient.prepareGarbageCollectionCommits(org.mockito.ArgumentMatchers.eq(repo),
          ...
          withSparkSession(spark => {
            ...
            spark.sparkContext.hadoopConfiguration.set("lakefs.api.url",
            ...
            val lister = new ActiveCommitsAddressLister(
              mockClient,
              repo,
              storageType,
              LakeFSContext.DEFAULT_LAKEFS_CONF_GC_PREPARE_COMMITS_TIMEOUT_SECONDS
            )
            ...
            Mockito
              ...
              .prepareGarbageCollectionCommits(org.mockito.ArgumentMatchers.eq(repo),
                                               org.mockito.ArgumentMatchers.anyInt()
                                              )
      ...
      it("should fallback to NaiveCommittedAddressLister on 404 error") {
        ...
        withSparkSession(spark => {
          ...
          Mockito
            .verify(mockClient, Mockito.atLeastOnce())
            .prepareGarbageCollectionCommits(org.mockito.ArgumentMatchers.eq(repo),
                                             org.mockito.ArgumentMatchers.anyInt()
                                            )

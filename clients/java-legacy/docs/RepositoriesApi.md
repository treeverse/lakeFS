...
# **deleteRepository**
> deleteRepository(repository, force)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteRepository(repository, force);
    } catch (ApiException e) {
...
<a name="getGCRules"></a>
# **getGCRules**
> GarbageCollectionRules getGCRules(repository)
...
<a name="restoreSubmit"></a>
# **restoreSubmit**
> TaskInfo restoreSubmit(repository, refsRestore)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.setBranchProtectionRules(repository, branchProtectionRule, ifMatch);
    } catch (ApiException e) {

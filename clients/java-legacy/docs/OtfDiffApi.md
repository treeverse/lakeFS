...
------------- | ------------- | -------------
[**getOtfDiffs**](OtfDiffApi.md#getOtfDiffs) | **GET** /otf/diffs | get the available Open Table Format diffs
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling OtfDiffApi#getOtfDiffs");

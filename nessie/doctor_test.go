...
func TestDoctor(t *testing.T) {
	...
	RunCmdAndVerifyFailureWithFile(t, LakectlWithParams("AKIAJOIHCOZ5JBYHCSDA", secretAccessKey, endPointURL)+" doctor", false, "lakectl_doctor_with_wrong_sufix_access_key_id", emptyVars)

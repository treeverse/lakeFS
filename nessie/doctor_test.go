...
func TestDoctor(t *testing.T) {
	...
	RunCmdAndVerifySuccessWithFile(t, LakectlWithParams(accessKeyID, secretAccessKey, endPointURL)+" doctor -v", false, "lakectl_doctor_ok_verbose", emptyVars)
	RunCmdAndVerifyFailureWithFile(t, lakectlLocation()+" doctor -c not_exits.yaml -v", false, "lakectl_doctor_not_exists_file", emptyVars)
	RunCmdAndVerifySuccessWithFile(t, LakectlWithParams(accessKeyID, secretAccessKey, endPointURL+"1")+" doctor -v", false, "lakectl_doctor_wrong_endpoint_verbose", emptyVars)
	RunCmdAndVerifySuccessWithFile(t, LakectlWithParams(accessKeyID, secretAccessKey, "wrong_uri")+" doctor -v", false, "lakectl_doctor_wrong_uri_format_endpoint_verbose", emptyVars)
	RunCmdAndVerifySuccessWithFile(t, LakectlWithParams("AKIAJZZZZZZZZZZZZZZQ", secretAccessKey, endPointURL)+" doctor -v", false, "lakectl_doctor_with_wrong_credentials_verbose", emptyVars)
	RunCmdAndVerifySuccessWithFile(t, LakectlWithParams("AKIAJOI!COZ5JBYHCSDQ", secretAccessKey, endPointURL)+" doctor -v", false, "lakectl_doctor_with_suspicious_access_key_id_verbose", emptyVars)
	RunCmdAndVerifySuccessWithFile(t, LakectlWithParams(accessKeyID, "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz", endPointURL)+" doctor -v", false, "lakectl_doctor_with_wrong_credentials_verbose", emptyVars)
	RunCmdAndVerifySuccessWithFile(t, LakectlWithParams(accessKeyID, "TQG5JcovOozCGJnIRmIKH7Flq1tLxnuByi9/WmJ!", endPointURL)+" doctor -v", false, "lakectl_doctor_with_suspicious_secret_access_key_verbose", emptyVars)

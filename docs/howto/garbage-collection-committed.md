...
spark-submit --class io.treeverse.clients.GarbageCollector \
  ...
  http://treeverse-clients-us-east.s3-website-us-east-1.amazonaws.com/lakefs-spark-client-312-hadoop3/0.8.0/lakefs-spark-client-312-hadoop3-assembly-0.8.0.jar \
...
spark-submit --class io.treeverse.clients.GarbageCollector \
  ...
  -c spark.hadoop.fs.s3a.access.key=<S3_ACCESS_KEY> \
  -c spark.hadoop.fs.s3a.secret.key=<S3_SECRET_KEY> \
  http://treeverse-clients-us-east.s3-website-us-east-1.amazonaws.com/lakefs-spark-client-301/0.8.0/lakefs-spark-client-301-assembly-0.8.0.jar \
  example-repo us-east-1
  ```
  </div>
...
spark-submit --class io.treeverse.clients.GarbageCollector \
  ...
  -c spark.hadoop.fs.s3a.access.key=<S3_ACCESS_KEY> \
  -c spark.hadoop.fs.s3a.secret.key=<S3_SECRET_KEY> \
  http://treeverse-clients-us-east.s3-website-us-east-1.amazonaws.com/lakefs-spark-client-247/0.8.0/lakefs-spark-client-247-assembly-0.8.0.jar \
  example-repo us-east-1
  ```
  </div>

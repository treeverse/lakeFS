...
This section explains how to use the lakeFS UI to manage rules. You can also use the [command line](../reference/cli.md#lakectl-branch-protect) and [API](../reference/api.md).

...
Only merges are allowed into protected branches. Together with the power of pre-merge [hooks](../understanding/use_cases/cicd_for_data.md#using-hooks-as-data-quality-gates),
...
To operate on a protected branch, merge commits from other branches into it. Use pre-merge [hooks](../understanding/use_cases/cicd_for_data.md#using-hooks-as-data-quality-gates)

...
**Note**
In this example we set `fs.s3a.path.style.access` in order to remove the need to set up DNS for [virtual hosting](https://docs.aws.amazon.com/AmazonS3/latest/userguide/VirtualHosting.html)

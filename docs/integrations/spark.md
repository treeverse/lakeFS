...
Install a Maven package with the `io.lakefs:hadoop-lakefs-assembly:0.1.8` coordinates.
...
1. Configure the S3A filesystem with your S3 credentials (**not** the lakeFS credentials).

...
To understand how hooks work and how to configure hooks in your production system, refer to the documentation: [Hooks](../../understanding/use_cases/cicd_for_data.md#using-hooks-as-data-quality-gates). 

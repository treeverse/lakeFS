...
|---------------|--------------------------------------------------------------------------------------------------------------------|
| 3.x           | `https://treeverse-clients-us-east.s3.amazonaws.com/lakefs-spark-client/0.20.0/lakefs-spark-client_2.12-assembly-0.20.0.jar` |
| 4.x           | `https://treeverse-clients-us-east.s3.amazonaws.com/lakefs-spark-client/0.20.0/lakefs-spark-client_2.13-assembly-0.20.0.jar` |
...
=== "AWS"
    ...
    spark-submit --class io.treeverse.gc.GarbageCollection \
        ...
        https://treeverse-clients-us-east.s3.amazonaws.com/lakefs-spark-client/0.20.0/lakefs-spark-client_<SCALA_VERSION>-assembly-0.20.0.jar \

...
|---------------|--------------------------------------------------------------------------------------------------------------------|
| 3.x           | `https://treeverse-clients-us-east.s3.amazonaws.com/lakefs-spark-client//lakefs-spark-client_2.12-assembly-.jar` |
| 4.x           | `https://treeverse-clients-us-east.s3.amazonaws.com/lakefs-spark-client//lakefs-spark-client_2.13-assembly-.jar` |
...
=== "AWS"
    ...
    spark-submit --class io.treeverse.gc.GarbageCollection \
        ...
        https://treeverse-clients-us-east.s3.amazonaws.com/lakefs-spark-client//lakefs-spark-client_<SCALA_VERSION>-assembly-.jar \

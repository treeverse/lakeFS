...
For larger repositories, running [distcp](https://hadoop.apache.org/docs/stable/hadoop-distcp/DistCp.html){: target="_blank"} with lakeFS as the source is also an option.

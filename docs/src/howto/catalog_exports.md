...
| **AWS Glue Catalog (+ Athena) exporter** | Creates a table in Glue using Hive's format and updates the location to symlink files (reuses Symlink Exporter).                                                                                                                                                                                                                                                                          | For Iceberg tables, see the [Glue Catalog Federation](../integrations/glue_metastore.md) integration instead                                                         |

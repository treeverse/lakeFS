...
Now we'll make a change to the data. lakeFS has several native clients, as well as an [S3-compatible endpoint](https://docs.lakefs.io/understand/architecture/#s3-gateway). This means that anything that can use S3 will work with lakeFS. Pretty neat.

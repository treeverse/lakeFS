...
!!! tip
    If you don't want to install lakeFS locally, you can use the [free trial of lakeFS Cloud](https://lakefs.io/cloud-registration). Once you launch the free trial you will have access to the same content as this quickstart within the provided repository once you login.

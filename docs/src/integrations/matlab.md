...
1. **lakeFS Server**: Running instance (local or cloud)
   - [Quick Start Guide](https://docs.lakefs.io/quickstart/)
   - [Cloud Setup](https://lakefs.cloud)

2. **lakectl CLI**: Installed and configured
   - [lakectl Installation](https://docs.lakefs.io/reference/cli/oss/)
   - Configuration file at `~/.lakectl.yaml`

3. **Everest** (optional, for mounting): File system interface
   - [Everest Documentation](https://docs.lakefs.io/reference/mount/)
...
- [lakectl CLI Reference](https://docs.lakefs.io/reference/cli/oss/)
- [Everest Mount Reference](https://docs.lakefs.io/reference/mount/)

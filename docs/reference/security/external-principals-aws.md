...
1. lakeFS should be [configured](#server-configuration) to allow external principals to authenticate and the users IAM role should be [attached](#administration-of-iam-roles-in-lakefs) to the lakeFS user

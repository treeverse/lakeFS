...
**Note**
⚠️ Everest is generally available. There is no installation required, please [contact us](http://info.lakefs.io/thanks-lakefs-mounts) to get access to the Everest binary.
{: .note }

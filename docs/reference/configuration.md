...
+ `email.lakefs_base_URL_endpoint` `(string : "http://localhost:8000")` - A string representing the base endpoint to be directed to when emails are sent inviting users, reseting passwords etc. 

...
<div class="tabs">
  ...
  ```bash
  spark-shell --packages io.lakefs:lakefs-spark-client-247_2.11:0.2.1
  ```
  
  Alternatively an assembled jar is available on S3, at
  `s3://treeverse-clients-us-east/lakefs-spark-client-247/0.2.1/lakefs-spark-client-247-assembly-0.2.1.jar`
  </div>
  ...
  ```bash
  spark-shell --packages io.lakefs:lakefs-spark-client-301_2.12:0.2.1
  ```
  
  Alternatively an assembled jar is available on S3, at
  `s3://treeverse-clients-us-east/lakefs-spark-client-301/0.2.1/lakefs-spark-client-301-assembly-0.2.1.jar`
  </div> 
  ...
  ```bash
  spark-shell --packages io.lakefs:lakefs-spark-client-312-hadoop3-assembly_2.12:0.2.1
  ```

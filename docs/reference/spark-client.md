...
```bash
spark-shell --packages io.lakefs:lakefs-spark-client_2.12:0.14.2
```

Alternatively use the assembled jar (an "Überjar") on S3, from
`s3://treeverse-clients-us-east/lakefs-spark-client/0.14.2/lakefs-spark-client-assembly-0.14.2.jar`

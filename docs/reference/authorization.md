...
| Prepare Garbage Collection Commits | `retention:PrepareGarbageCollection`  | `arn:lakefs:fs:::repository/{repositoryId}`                              | POST /repositories/{repositoryId}/gc/prepare_commits                                | -                                                                     |

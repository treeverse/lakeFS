...
**Note**
At this point, lakeFS supports Garbage Collection only on S3, and Azure but we have [concrete plans](https://github.com/treeverse/lakeFS/issues/3626) to extend the support to GCP.     
{: .note}

...
1. Follow the official [Google documentation](https://cloud.google.com/sql/docs/postgres/quickstart#create-instance){: .button-clickable} on how to create a PostgreSQL instance.
...
1. Choose the method by which lakeFS [will connect to your database](https://cloud.google.com/sql/docs/postgres/connect-overview){: .button-clickable}. Google recommends using
   the [SQL Auth Proxy](https://cloud.google.com/sql/docs/postgres/sql-proxy){: .button-clickable}.

Depending on the chosen lakeFS installation method, you will need to make sure lakeFS can access your database.
For example, if you install lakeFS on GKE, you need to deploy the SQL Auth Proxy from [this Helm chart](https://github.com/rimusz/charts/blob/master/stable/gcloud-sqlproxy/README.md){: .button-clickable}, or as [a sidecar container in your lakeFS pod](https://cloud.google.com/sql/docs/mysql/connect-kubernetes-engine){: .button-clickable}.
...
1. [Download the binary](../index.md#downloads){: .button-clickable} to the GCE instance.

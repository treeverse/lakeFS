...
{: .note}
> SSO is also available for [lakeFS Enterprise]({% link enterprise/sso.md %}). Using the open-source version of lakeFS? Read more on [authentication]({% link reference/security/authentication.md %}). 

...
{: .note}
> Managed GC is only available for [lakeFS Cloud]({% link cloud/ %}). If you are using the self-managed lakeFS, garbage collection is [available to run manually]({% link howto/garbage-collection-index.md %}).

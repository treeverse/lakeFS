...
lakeFS supports S3 and GCS as its underlying storage service. It is [API compatible with AWS S3](reference/s3.md) and works seamlessly with all modern data frameworks such as Spark, Hive, AWS Athena, Presto, etc.

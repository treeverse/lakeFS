...
{: .note}
> SSO is also available on [lakeFS Cloud]({% link cloud/sso.md %}). Using the open-source version of lakeFS? Read more about [authentication]({% link reference/security/authentication.md %}). 

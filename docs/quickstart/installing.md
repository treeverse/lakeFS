...
1. Ensure you have Docker & Docker Compose installed on your computer, and that compose version is 1.25.04 or higher. For more information, please see the [following issue](https://github.com/treeverse/lakeFS/issues/894). 

...
_Hooks_ can be either a [Lua](/hooks/lua.html) script that lakeFS will execute itself, an external [web hook](/hooks/webhook.html), or an [Airflow DAG](/hooks/airflow.html). In this example, we're using a Lua hook.

...
_Hooks_ can be either a [Lua](../howto/hooks/lua.html) script that lakeFS will execute itself, an external [web hook](../howto/hooks/webhook.html), or an [Airflow DAG](../howto/hooks/airflow.html). In this example, we're using a Lua hook.

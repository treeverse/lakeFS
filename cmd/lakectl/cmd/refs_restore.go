...
func init() {
	...
	refsRestoreCmd.Flags().Duration("poll-interval", defaultPullInterval, "poll status check interval")
	refsRestoreCmd.Flags().Duration("poll-expiry", defaultPullExpiry, "poll status check expiry")

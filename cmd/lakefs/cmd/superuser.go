...
var superuserCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		authService := auth_acl.NewAuthService(kvStore, crypt.NewSecretStore([]byte(cfg.Auth.Encrypt.SecretKey)), authparams.ServiceCache(cfg.Auth.Cache), logger.WithField("service", "auth_service"))

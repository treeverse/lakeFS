...
publish-scala: ## sbt publish spark client jars to Maven Central and to s3 bucket
	cd clients/spark && sbt -DhadoopVersion=3.2.1 'set version := "0.15.1-hadoop-3.2.1"; assembly; publishSigned; s3Upload; sonaRelease' && \
          sbt -DhadoopVersion=3.3.6 'set version := "0.15.1-hadoop-3.3.6"; assembly; publishSigned; s3Upload; sonaRelease'

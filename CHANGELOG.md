...
- Changed lakeFS's license from Apache 2.0 to the Business Source License 1.1 (#10536)
    ...
    - Versions released before v1.87.0 remain licensed under Apache 2.0
...
Refer to [documentation](https://docs.lakefs.io/security/access-control-lists/) for more information.
...
* Not just the [lakeFS Open API](https://docs.lakefs.io/reference/api/oss/): This is also true for the [new lakeFS Python SDK](https://docs.lakefs.io/integrations/python/#using-the-lakefs-sdk), the [Java SDK](https://central.sonatype.com/artifact/io.lakefs/sdk?smo=true) and the [lakectl CLI](https://docs.lakefs.io/reference/cli/oss/) tool.
...
[lakeFS 1.0 - Code Migration Guide](https://docs.lakefs.io/project/code-migrate-1.0-sdk/)

For more information on the benefits of upgrading to 1.0 and the migration path, please refer to the [lakeFS documentation](https://docs.lakefs.io/project/code-migrate-1.0-sdk/) or [reach out on Slack](https://lakefs.io/slack).
...
The lakeFS service will not run if the migration version isn't compatible with the binary.
Before running the new version you will be required to run migrate, with the new version.
Please refer to this [upgrade documentation](https://docs.lakefs.io/security/access-control-lists/#migrating-from-the-previous-version-of-acls) for more information on the specific migration from RBAC to ACL
...
The lakeFS service will not run if the migration version isn't compatible with the binary.
Before running the new version you will be required to run migrate, with the new version.
Please refer to this [upgrade documentation](https://docs.lakefs.io/howto/deploy/upgrade/#lakefs-0800-or-greater-kv-migration) for more information on the specific migration to KV
...
Check our updated [Deploy lakeFS](https://docs.lakefs.io/howto/deploy/#deploy-lakefs) page, for deployment instructions.
Also make sure to check our [Sizing Guide](https://docs.lakefs.io/howto/sizing-guide/#lakefs-kv-store) for best practices, requirements and benchmarks
...
2e2e005a ingest cmd [Importing data from an object store without actually copying it](https://docs.lakefs.io/howto/import/#importing-data-from-an-object-store-without-actually-copying-it) (#1864)
...
For more information, see the [Python Client Documentation](https://docs.lakefs.io/integrations/python/).
...
For more information, see the [Export Job configuration Documentation](https://docs.lakefs.io/howto/export/).
...
For more information, see the [CLI Command Reference Documentation](https://docs.lakefs.io/reference/cli/oss/).
...
https://docs.lakefs.io/howto/deploy/upgrade/

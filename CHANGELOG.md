...
- OSS documentation is now available at community.lakefs.io (#10339)
...
- Removed unimplemented endpoints and Enterprise-only parameters from the OpenAPI spec to accurately reflect what's available in OSS (#10370)

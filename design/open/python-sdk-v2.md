...
Pydantic V1 is not supported on Python 3.14+ — Python 3.14 introduces new type annotation semantics (PEP 649 / PEP 749) that V1 cannot accommodate, making Python 3.13 the last supported version for Pydantic V1 ([reference](https://pydantic.dev/articles/pydantic-v2-12-release)).

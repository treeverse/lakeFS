...
In addition to adding entry to the staging area, add reference to physical address.
**Open:** How do we validate address was generated by a call to GetPhysicalAddress

#### CopyObject

**Open:** If and how to support copy object

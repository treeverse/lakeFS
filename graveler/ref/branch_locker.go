...
func (l *BranchLocker) Writer(ctx context.Context, repositoryID graveler.RepositoryID, branchID graveler.BranchID, lockedFn graveler.BranchLockerFunc) (interface{}, error) {
	writerLockKey := calculateBranchLockerKeys(repositoryID, branchID)
...
func calculateBranchLockerKeys(repositoryID graveler.RepositoryID, branchID graveler.BranchID) int64 {
	h := fnv.New64()

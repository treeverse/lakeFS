...
import (
	...
	sstable0 "github.com/treeverse/lakefs/graveler/committed/sstable"
	reflect "reflect"
)
...
func (m *Mockcache) GetOrOpen(namespace string, id committed.ID) (*sstable.Reader, sstable0.Derefer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOrOpen", namespace, id)
	ret0, _ := ret[0].(*sstable.Reader)
	ret1, _ := ret[1].(sstable0.Derefer)
	ret2, _ := ret[2].(error)

...
type VersionController interface {
	...
	Merge(ctx context.Context, repositoryID RepositoryID, theirs BranchID, ours Ref, commitParams CommitParams) (CommitID, DiffSummary, error)
...
func (g *Graveler) Merge(ctx context.Context, repositoryID RepositoryID, theirs BranchID, ours Ref, commitParams CommitParams) (CommitID, DiffSummary, error) {

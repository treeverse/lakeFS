...
type EntryCatalog interface {
	FlushToMetaRange(ctx context.Context, repositoryID graveler.RepositoryID, it graveler.ValueIterator) (*graveler.MetaRangeID, error)
...
func (c *CatalogRepoActions) ApplyImport(ctx context.Context, it Iterator, _ bool) (*Stats, error) {
	...
	c.createdMetaRangeID, err = c.entryCatalog.FlushToMetaRange(ctx, c.repoID,

...
func GenerateJWTLogin(secret []byte, userID string, issuedAtUnixTime, expiresAtUnixTime int64) (string, error) {
	claims := &jwt.StandardClaims{
		Id:        uuid.NewString(),
		Audience:  LoginAudience,
		Subject:   userID,
		IssuedAt:  issuedAtUnixTime,
		ExpiresAt: expiresAtUnixTime,
	}

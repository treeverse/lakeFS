...
func TestAction_Match(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			on:      actions.OnEvents{Events: map[string]*actions.ActionOn{string(graveler.EventTypePreCreateTag): {}}},
		...
		},
		{
			...
			on:      actions.OnEvents{Events: map[string]*actions.ActionOn{string(graveler.EventTypePostCreateTag): {}}},
		...
		},
		{
			...
			on:      actions.OnEvents{Events: map[string]*actions.ActionOn{string(graveler.EventTypePreDeleteTag): {}}},
		...
		},
		{
			...
			on:      actions.OnEvents{Events: map[string]*actions.ActionOn{string(graveler.EventTypePostDeleteTag): {}}},
		...
		},
		{
			...
			on:      actions.OnEvents{Events: map[string]*actions.ActionOn{string(graveler.EventTypePreCreateBranch): {Branches: []string{"main"}}}},
		...
		},
		{
			...
			on:      actions.OnEvents{Events: map[string]*actions.ActionOn{string(graveler.EventTypePostCreateBranch): {Branches: []string{"main"}}}},
		...
		},
		{
			...
			on:      actions.OnEvents{Events: map[string]*actions.ActionOn{string(graveler.EventTypePreDeleteBranch): {Branches: []string{"main"}}}},
		...
		},
		{
			...
			on:      actions.OnEvents{Events: map[string]*actions.ActionOn{string(graveler.EventTypePostDeleteBranch): {Branches: []string{"main"}}}},

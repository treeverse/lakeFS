...
func TestAction_Match(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			on:      actions.OnEvents{PreCreateTag: &actions.ActionOn{}},
		...
		},
		{
			...
			on:      actions.OnEvents{PreCreateTag: &actions.ActionOn{Branches: []string{"main"}}},
		...
		},
		{
			...
			on:      actions.OnEvents{PostCreateTag: &actions.ActionOn{Branches: []string{"main"}}},
		...
		},
		{
			...
			on:      actions.OnEvents{PreDeleteTag: &actions.ActionOn{Branches: []string{"main"}}},
		...
		},
		{
			...
			on:      actions.OnEvents{PostDeleteTag: &actions.ActionOn{Branches: []string{"main"}}},
		...
		},
		{
			...
			on:      actions.OnEvents{PreCreateBranch: &actions.ActionOn{Branches: []string{"main"}}},
		...
		},
		{
			...
			on:      actions.OnEvents{PostCreateBranch: &actions.ActionOn{Branches: []string{"main"}}},
		...
		},
		{
			...
			on:      actions.OnEvents{PreDeleteBranch: &actions.ActionOn{Branches: []string{"main"}}},
		...
		},
		{
			...
			on:      actions.OnEvents{PostDeleteBranch: &actions.ActionOn{Branches: []string{"main"}}},

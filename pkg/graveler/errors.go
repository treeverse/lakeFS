...
var (
	...
	ErrCommitToProtectedBranch      = errors.New("commit failed because branch is protected")
	...
	ErrDereferenceCommitWithStaging = errors.New("reference to commit cannot include staging area modifier")
)

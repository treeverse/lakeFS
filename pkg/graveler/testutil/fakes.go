...
func (c *CommittedFake) Merge(_ context.Context, _ graveler.StorageNamespace, _, _, _ graveler.MetaRangeID, _ graveler.MergeStrategy, _ bool) (graveler.MetaRangeID, error) {
	if c.Err != nil {
		return "", c.Err
	}

...
func (m *MockConflictsResolver) ResolveConflict(ctx context.Context, crCtx graveler.ConflictsResolverContext, sourceValue, destValue *graveler.ValueRecord) (*graveler.ValueRecord, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResolveConflict", ctx, crCtx, sourceValue, destValue)
...
func (mr *MockConflictsResolverMockRecorder) ResolveConflict(ctx, crCtx, sourceValue, destValue interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResolveConflict", reflect.TypeOf((*MockConflictsResolver)(nil).ResolveConflict), ctx, crCtx, sourceValue, destValue)
}

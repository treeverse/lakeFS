...
func (x *StagedObject) GetKey() []byte {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *StagedObject) GetIdentity() []byte {
	if x != nil {
		return x.Identity
	}
	return nil
...
func (x *StagedObject) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_graveler_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x50, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x67,
	0x65, 0x64, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x64,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x2a, 0x3e, 0x0a, 0x1d, 0x42, 0x72,
...
var file_graveler_proto_goTypes = []interface{}{
	...
	(*StagedObject)(nil),                   // 8: io.treeverse.lakefs.graveler.StagedObject

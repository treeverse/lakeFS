...
// message data model to track link addresses token
...
func (x *AddressData) GetExpiredAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiredAt
	}
	return nil
...
var file_graveler_proto_rawDesc = []byte{
	...
	0x22, 0x62, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x44, 0x61, 0x74, 0x61, 0x12,
	...
	0x65, 0x64, 0x41, 0x74, 0x2a, 0x2e, 0x0a, 0x0f, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f,
...
var file_graveler_proto_goTypes = []interface{}{
	...
	(*AddressData)(nil),                    // 11: io.treeverse.lakefs.graveler.AddressData
...
var file_graveler_proto_depIdxs = []int32{
	...
	15, // 7: io.treeverse.lakefs.graveler.AddressData.expired_at:type_name -> google.protobuf.Timestamp

...
func TestValidateBranchID(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "char1", branchID: "valid~char", wantErr: nil},
		{name: "alpha dot numeric", branchID: "valid1.0", wantErr: nil},
		{name: "alpha two dots", branchID: "valid..branch", wantErr: nil},
		{name: "ends with dot", branchID: "valid.", wantErr: nil},
		{name: "alpha slash", branchID: "invalid/branch", wantErr: ErrInvalidBranchID},
		{name: "alpha double slash", branchID: "invalid//branch", wantErr: ErrInvalidBranchID},
		{name: "alpha question mark", branchID: "valid?branch", wantErr: nil},
		{name: "alpha at", branchID: "valid@branch", wantErr: nil},
		{name: "alpha column", branchID: "valid:branch", wantErr: nil},
		{name: "alpha backslash", branchID: "valid\\branch", wantErr: nil},
		{name: "alpha square brackets", branchID: "valid[branch]", wantErr: nil},
		{name: "alpha curly brackets", branchID: "valid{branch}", wantErr: nil},
		{name: "space", branchID: "invalid branch", wantErr: ErrInvalidBranchID},
		{name: "tab", branchID: "invalid\tbranch", wantErr: ErrInvalidBranchID},
	}	

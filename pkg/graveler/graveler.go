...
type VersionController interface {
	...
	// SetLinkAddress stores the link address token under the repository. The token will be valid for addressTokenTime.
	// or return ErrLinkAddressAlreadyExists if a token already exists.
	...
	// ListLinkAddresses lists link address tokens on a repository
...
type RefManager interface {
	...
	// VerifyLinkAddress verifies the given link address token
	VerifyLinkAddress(ctx context.Context, repository *RepositoryRecord, token string) error
	...
	// DeleteExpiredLinkAddresses deletes expired link address tokens on a repository
	DeleteExpiredLinkAddresses(ctx context.Context, repository *RepositoryRecord) error
...
func (g *Graveler) Log(ctx context.Context, repository *RepositoryRecord, commitID CommitID) (CommitIterator, error) {

...
func (c *committedManager) Merge(ctx context.Context, ns graveler.StorageNamespace, destination, source, base graveler.MetaRangeID, strategy graveler.MergeStrategy, validate bool) (graveler.MetaRangeID, error) {
	if validate {
		if source == base {

...
func (c *Catalog) CreateBranchProtectionRule(ctx context.Context, repositoryID string, pattern string, constraints *graveler.BranchProtectionConstraints) error {

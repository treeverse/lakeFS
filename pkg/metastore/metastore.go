...
func (m *Table) Update(db, table, inputFormat, serde string, transformLocation func(location string) (string, error), isSparkSQLTable, fixSparkPlaceHolder bool) error {
	...
	m.DBName = db
	m.TableName = table
	err := m.Sd.Update(db, table, inputFormat, serde, transformLocation, isSparkSQLTable, fixSparkPlaceHolder)
	if err != nil {
...
func (m *Partition) Update(db, table, inputFormat, serde string, transformLocation func(location string) (string, error), isSparkSQLTable, fixSparkPlaceHolder bool) error {
	log := logging.Default().WithFields(logging.Fields{
		"db":          db,
		"table":       table,
		"serde":       serde,
...
func (m *StorageDescriptor) Update(db, table, inputFormat, serde string, transformLocation func(location string) (string, error), isSparkSQLTable, fixSparkPlaceHolder bool) error {
	if m.SerdeInfo == nil {

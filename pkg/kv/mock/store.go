...
func (m *MockDriver) Open(ctx context.Context, params params.KV) (kv.Store, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Scan(ctx context.Context, partitionKey, start []byte) (kv.EntriesIterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Scan", ctx, partitionKey, start)
...
func (mr *MockStoreMockRecorder) Scan(ctx, partitionKey, start interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Scan", reflect.TypeOf((*MockStore)(nil).Scan), ctx, partitionKey, start)
}

...
type CredentialsWithSecret struct {
	...
	// UserName A unique identifier for the user. In password-based authentication should be the email.
...
type UserCreation struct {
	...
	// Invite If true, send an invitation by email. Otherwise, only create the user.
	Invite *bool   `json:"invite,omitempty"`
	Source *string `json:"source,omitempty"`

	// Username A unique identifier for the user. For password-based authentication, it is the email.
	Username string `json:"username"`
}
...
type CreateCredentialsParams struct {
	...
	SecretKey *string `form:"secret_key,omitempty" json:"secret_key,omitempty"`
}
...
type ClaimTokenIdJSONRequestBody = ClaimTokenId
...
type UpdatePasswordJSONRequestBody = UserPassword
...
type ClientInterface interface {
	...
	// ClaimTokenIdWithBody request with any body
...
type ClientWithResponsesInterface interface {
	...
	// ClaimTokenIdWithBodyWithResponse request with any body
	...
	// GetCredentialsForUserWithResponse request

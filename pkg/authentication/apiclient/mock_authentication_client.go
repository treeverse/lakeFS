...
func (m *MockClientWithResponsesInterface) HealthCheckWithResponse(arg0 context.Context, arg1 ...RequestEditorFn) (*HealthCheckResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockClientWithResponsesInterface) LDAPLoginWithBodyWithResponse(arg0 context.Context, arg1 string, arg2 io.Reader, arg3 ...RequestEditorFn) (*LDAPLoginResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*LDAPLoginResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClientWithResponsesInterface) LDAPLoginWithResponse(arg0 context.Context, arg1 LDAPLoginJSONRequestBody, arg2 ...RequestEditorFn) (*LDAPLoginResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockClientWithResponsesInterface) OauthCallbackWithResponse(arg0 context.Context, arg1 ...RequestEditorFn) (*OauthCallbackResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*OauthCallbackResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClientWithResponsesInterface) STSLoginWithBodyWithResponse(arg0 context.Context, arg1 string, arg2 io.Reader, arg3 ...RequestEditorFn) (*STSLoginResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1, arg2}
	for _, a := range arg3 {
		varargs = append(varargs, a)
...
func (m *MockClientWithResponsesInterface) STSLoginWithResponse(arg0 context.Context, arg1 STSLoginJSONRequestBody, arg2 ...RequestEditorFn) (*STSLoginResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)

...
func (m *MetricsAdapter) GetStorageNamespaceInfo(storageID string) *StorageNamespaceInfo {
	concurrentOperations.WithLabelValues("get_storage_namespace_info", m.adapter.BlockstoreType()).Inc()
	defer concurrentOperations.WithLabelValues("get_storage_namespace_info", m.adapter.BlockstoreType()).Dec()

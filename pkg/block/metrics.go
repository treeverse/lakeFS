...
func NewMetricsAdapter(adapter Adapter, service string) Adapter {
	return &MetricsAdapter{adapter: adapter, service: service}
}
...
func (m *MetricsAdapter) Put(ctx context.Context, obj ObjectPointer, sizeBytes int64, reader io.Reader, opts PutOpts) (*PutResponse, error) {
	...
	concurrentOperations.WithLabelValues("put", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("put", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) Get(ctx context.Context, obj ObjectPointer) (io.ReadCloser, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("get", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("get", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) GetPreSignedURL(ctx context.Context, obj ObjectPointer, mode PreSignMode, filename string) (string, time.Time, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("get_presigned_url", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("get_presigned_url", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) GetPresignUploadPartURL(ctx context.Context, obj ObjectPointer, uploadID string, partNumber int) (string, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("get_presign_upload_part_url", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("get_presign_upload_part_url", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) Exists(ctx context.Context, obj ObjectPointer) (bool, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("exists", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("exists", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) GetRange(ctx context.Context, obj ObjectPointer, startPosition int64, endPosition int64) (io.ReadCloser, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("get_range", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("get_range", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) GetProperties(ctx context.Context, obj ObjectPointer) (Properties, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("get_properties", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("get_properties", m.adapter.BlockstoreType(), m.service).Dec()
	return m.adapter.GetProperties(ctx, obj)
}

func (m *MetricsAdapter) Remove(ctx context.Context, obj ObjectPointer) error {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("remove", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("remove", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) Copy(ctx context.Context, sourceObj, destinationObj ObjectPointer) error {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("copy", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("copy", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) CreateMultiPartUpload(ctx context.Context, obj ObjectPointer, r *http.Request, opts CreateMultiPartUploadOpts) (*CreateMultiPartUploadResponse, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("create_multipart_upload", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("create_multipart_upload", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) UploadPart(ctx context.Context, obj ObjectPointer, sizeBytes int64, reader io.Reader, uploadID string, partNumber int) (*UploadPartResponse, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("upload_part", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("upload_part", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) ListParts(ctx context.Context, obj ObjectPointer, uploadID string, opts ListPartsOpts) (*ListPartsResponse, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("list_parts", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("list_parts", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) ListMultipartUploads(ctx context.Context, obj ObjectPointer, opts ListMultipartUploadsOpts) (*ListMultipartUploadsResponse, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("list_multipart_uploads", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("list_multipart_uploads", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) UploadCopyPart(ctx context.Context, sourceObj, destinationObj ObjectPointer, uploadID string, partNumber int) (*UploadPartResponse, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("upload_copy_part", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("upload_copy_part", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) UploadCopyPartRange(ctx context.Context, sourceObj, destinationObj ObjectPointer, uploadID string, partNumber int, startPosition, endPosition int64) (*UploadPartResponse, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("upload_copy_part_range", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("upload_copy_part_range", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) AbortMultiPartUpload(ctx context.Context, obj ObjectPointer, uploadID string) error {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("abort_multipart_upload", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("abort_multipart_upload", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) CompleteMultiPartUpload(ctx context.Context, obj ObjectPointer, uploadID string, multipartList *MultipartUploadCompletion) (*CompleteMultiPartUploadResponse, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("complete_multipart_upload", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("complete_multipart_upload", m.adapter.BlockstoreType(), m.service).Dec()
...
func (m *MetricsAdapter) GetRegion(ctx context.Context, storageID, storageNamespace string) (string, error) {
	ctx = httputil.SetClientTrace(ctx, m.adapter.BlockstoreType())
	concurrentOperations.WithLabelValues("get_region", m.adapter.BlockstoreType(), m.service).Inc()
	defer concurrentOperations.WithLabelValues("get_region", m.adapter.BlockstoreType(), m.service).Dec()

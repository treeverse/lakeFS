...
func (x *Diff) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_diff_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xcf, 0x01, 0x0a, 0x04, 0x44, 0x69, 0x66, 0x66, 0x12, 0x18,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x64, 0x69, 0x66, 0x66,
	0x2e, 0x44, 0x69, 0x66, 0x66, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x45, 0x6e, 0x74,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x30, 0x0a, 0x0c, 0x44, 0x69, 0x66, 0x66, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x05, 0x64, 0x69, 0x66, 0x66, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x64, 0x69, 0x66, 0x66, 0x2e, 0x44, 0x69,
	0x66, 0x66, 0x52, 0x05, 0x64, 0x69, 0x66, 0x66, 0x73, 0x32, 0x37, 0x0a, 0x06, 0x44, 0x69, 0x66,
	0x66, 0x65, 0x72, 0x12, 0x2d, 0x0a, 0x04, 0x44, 0x69, 0x66, 0x66, 0x12, 0x11, 0x2e, 0x64, 0x69,
	0x66, 0x66, 0x2e, 0x44, 0x69, 0x66, 0x66, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12,
	...
	0x73, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x2f, 0x64, 0x69, 0x66, 0x66, 0x62, 0x06,
...
var file_diff_proto_depIdxs = []int32{
	...
	5, // 2: diff.Diff.content:type_name -> diff.Diff.ContentEntry
	3, // 3: diff.DiffResponse.diffs:type_name -> diff.Diff
	2, // 4: diff.Differ.Diff:input_type -> diff.DiffRequest
	4, // 5: diff.Differ.Diff:output_type -> diff.DiffResponse

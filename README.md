...
lakeFS is API compatible with AWS S3, Google Cloud Storage (GCS), and works seamlessly with all modern data frameworks such as Spark, Hive, AWS Athena, Presto, etc.
